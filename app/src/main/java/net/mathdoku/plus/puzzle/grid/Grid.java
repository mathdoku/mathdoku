...
public class Grid {
    ...
    private void validateGridObjectsCreatorThrowsExceptionOnError() {
        if (mObjectsCreator == null) {
            throw new InvalidGridException("Cannot create a grid if mObjectsCreator is null.");
        }
    }
    ...
    public void clearCells() {
        ...
        if (mCells != null) {
            ...
            if (updateGridClearCounter) {
                mGridStatistics.increaseCounter(StatisticsCounterType.ACTION_CLEAR_GRID);
            }
        }
    ...
    public void revealSolution() {
        ...
        if (mGridGeneratingParameters != null && mGridGeneratingParameters.isHideOperators() &&
                mCages != null) {
            for (Cage cage : mCages) {
                cage.revealOperator();
     ...
     *
     * @param cell
     *         The cell to be selected. If null, then the current selected cell will be unselected.
     ...
     */
    public void clearRedundantPossiblesInSameRowOrColumn(CellChange originalCellChange) {
        if (mSelectedCell == null) {
            return;
        }
    ...
    /**
     * Upgrade this grid (solving attempt and statistics) to the current app version.
     *
     * @return True in case everything has been saved. False otherwise.
     */
    ...
    public Grid createNewGridForReplay() {
        ...
        for (Cell cell : mCells) {
            ...
            Cell newCell = cellBuilder.setGridSize(mGridSize)
        ...
        for (Cage cage : mCages) {
            ...
            Cage newCage = cageBuilder.setId(cage.getId())
        ...
        // Create a new grid
        return mObjectsCreator.createGridBuilder()
    ...
    public boolean revealSelectedCell() {
        ...
        if (Preferences.getInstance()
                .isPuzzleSettingClearMaybesEnabled()) {
        ...
        mGridStatistics.increaseCounter(StatisticsCounterType.ACTION_REVEAL_CELL);
     ...
     *
     * @return True in case the operator of the cage is revealed. False otherwise.
     */
    public boolean revealOperatorSelectedCage() {
        ...
        mGridStatistics.increaseCounter(StatisticsCounterType.ACTION_REVEAL_OPERATOR);

...
public class GridBuilder {
     ...
     */
    public GridBuilder setGridObjectsCreator(Grid.ObjectsCreator gridObjectsCreator) {
    ...
    public String toString() {
        ...
        stringBuilder.append("\tgridGeneratingParameters=" + mGridGeneratingParameters + "\n");

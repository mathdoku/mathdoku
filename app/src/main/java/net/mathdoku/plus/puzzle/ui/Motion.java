...
public class Motion {
    ...
    void setTouchDownEvent(MotionEvent motionEvent) {
        ...
        int[] previousTouchDownCellCoordinates = mTouchDownCellCoordinates.clone();
        ...
        mTouchDownCellCoordinates = toGridCoordinates(mTouchDownPixelCoordinates[X_POS],
                                                      mTouchDownPixelCoordinates[Y_POS]);

        // Determine whether a new double tap motion is started
        long timeSincePreviousEvent = motionEvent.getEventTime() - mDoubleTapTouchDownTime;
    ...
    /**
     * Checks whether this swipe motion completes a double tap on the touch down cell.
     *
     * @return True in case this swipe motion results in a double tap detection. False otherwise.
     */
     ...
     *
     * @return The cell coordinates for which the touch down event was registered.
     */
     ...
     *
     * @return The pixel coordinates for which the touch down event was registered.
     */
    ...
    /**
     * Checks whether the last known touch down position was inside or outside the grid.
     *

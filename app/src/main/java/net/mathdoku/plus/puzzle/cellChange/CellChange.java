...
public class CellChange {
    ...
    public String toString() {
        return "<cell:" + this.mCell.getCellId() + " col:" + this.mCell.getColumn() + " row:" +
                this.mCell.getRow() + " previous entered value:" + this.mPreviousEnteredValue + "" +
                " previous possible values:" + mPreviousPossibleValues.toString() + ">";
    }

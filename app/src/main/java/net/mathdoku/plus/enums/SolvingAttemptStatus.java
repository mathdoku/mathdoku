...
public enum SolvingAttemptStatus {
    ...
    private SolvingAttemptStatus(int solvingAttemptStatusId, StatusFilter attachedToStatusFilter) {
    ...
    public static SolvingAttemptStatus valueOf(int id) {
        ...
        if (firstSolvingAttemptStatus == null) {
            throw new IllegalStateException(
                    String.format("Value '%d' is not mapped to any solving attempt statuses.", id));
        }
     ...
     *
     * @param isRevealed
     *         True is the solution of the solving attempt is revealed. False otherwise.
     * @param isActive

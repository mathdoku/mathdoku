	...
	public static GridType fromGridTypeFilter(GridTypeFilter gridTypeFilter) {
			...
			if (gridType.getAttachedToGridTypeFilter() == gridTypeFilter) {
				if (firstGridType != null) {
					throw new IllegalStateException(String.format(
							"Cannot determine grid type as GridTypeFilter '%s' is "
									+ "attached to multiple grid types.",
							gridTypeFilter.name()));
				}
		...
		if (firstGridType == null) {
			throw new IllegalStateException(
					String
							.format("Cannot determine grid type as GridTypeFilter '%s' is attached to multiple grid types.",
									gridTypeFilter.name()));
		}

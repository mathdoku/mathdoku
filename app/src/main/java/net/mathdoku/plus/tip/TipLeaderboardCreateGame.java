...
public class TipLeaderboardCreateGame extends TipDialog {
    ...
    /**
     * Creates a new tip dialog which explains that leaderboards can be long tapped to create a new game for the
     * leaderboard.</br>
     * <p/>
    ...
    public TipLeaderboardCreateGame(Context context) {
        ...
        build(R.drawable.lightbulb, context.getResources()
                      .getString(R.string.dialog_tip_leaderboard_create_game_details_title), context.getResources()

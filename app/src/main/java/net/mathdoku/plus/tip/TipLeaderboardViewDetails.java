...
public class TipLeaderboardViewDetails extends TipDialog {
    ...
    private static final String TIP_NAME = "LeaderboardViewDetails";
    private static final TipPriority TIP_PRIORITY = TipPriority.LOW;

    /**
     * Creates a new tip dialog which explains that leaderboards can be tapped to view more details.</br>
     * <p/>
    ...
    public TipLeaderboardViewDetails(Context context) {
        ...
        build(R.drawable.lightbulb, context.getResources()
                      .getString(R.string.dialog_tip_leaderboard_view_details_title), context.getResources()
                      .getString(R.string.dialog_tip_leaderboard_view_details_text), null);
    }
    ...
    public static boolean toBeDisplayed(Preferences preferences) {
        ...
        if (preferences.getTipLastDisplayTime(TIP_NAME) > System.currentTimeMillis() - 2 * 24 * 60 * 60 * 1000) {
            return false;
        }

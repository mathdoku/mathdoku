...
public class TipStatistics extends TipDialog {
    ...
    private static final String TIP_NAME = "Statistics";
    private static final TipPriority TIP_PRIORITY = TipPriority.LOW;

    /**
     * Creates a new tip dialog which explains that the statistics have been made available.
     *
     * @param context
    ...
    public TipStatistics(Context context) {
        ...
        build(R.drawable.lightbulb, context.getResources()
                      .getString(R.string.dialog_tip_statistics_title), context.getResources()
    ...
    public static boolean toBeDisplayed(Preferences preferences) {
        ...
        if (preferences.getTipLastDisplayTime(
                TIP_NAME) > System.currentTimeMillis() - 12 * 60 * 60 * 1000) {
            return false;
        }

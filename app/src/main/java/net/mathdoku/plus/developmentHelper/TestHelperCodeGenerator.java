...
public class TestHelperCodeGenerator {
	...
	private void appendHeader() {
		...
		stringBuilder.append("/**\n");
		stringBuilder
				.append(" * This code is generated based on a grid which is generated by the app. To generate the code, use the app in Development Mode. Choose menu option Development Options -> Generate code for test helper.\n");
		stringBuilder.append(" *\n");

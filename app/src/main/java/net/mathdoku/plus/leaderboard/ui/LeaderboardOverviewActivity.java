...
public class LeaderboardOverviewActivity extends GooglePlayServiceFragmentActivity implements
    ...
    /**
     * The {@link ViewPager} that will display the leaderboard fragments , one at a time.
     */
    ...
    private void selectTabLastDisplayed() {
        ...
        mViewPager.setCurrentItem(tab >= 0 ? tab : mLeaderboardOverviewPagerAdapter.getCount() - 1);
    }
    ...
    private class PageChangeListener extends ViewPager.SimpleOnPageChangeListener {
        ...
        public void onPageSelected(int position) {
            ...
            if (leaderboardOverview != null) {
                leaderboardOverview.setLeaderboardFilter(getLeaderboardFilter());
            }
    ...
    protected void onResumeFragments() {
        setFilterSpinner(mMathDokuPreferences.getLeaderboardFilterLastValueUsed());
        super.onResumeFragments();
    }

    @Override
    protected void onPause() {
        mMathDokuPreferences.setLeaderboardFilterLastValueUsed(getLeaderboardFilter());
        mMathDokuPreferences.setLeaderboardsTabLastDisplayed(mViewPager.getCurrentItem());
    ...
    private View inflateLeaderboardHelpDialog() {
        return LayoutInflater.from(this)
                .inflate(R.layout.leaderboard_help_dialog, null);
    }
    ...
    public void onSignInFailed() {
        GooglePlusSignInDialog googlePlusSignInDialog = new GooglePlusSignInDialog(this,
                ...
                R.string.google_plus_login_dialog_on_show_leaderboards);
        ...
        mLeaderboardRankUpdaterProgressDialog.setOnDismissListener(new OnDismissListener() {
            ...
            public void onDismiss(DialogInterface dialog) {
                ...
                if (TipLeaderboardViewDetails.toBeDisplayed(mMathDokuPreferences)) {
                    new TipLeaderboardViewDetails(LeaderboardOverviewActivity.this).show();
                }
                if (TipLeaderboardCreateGame.toBeDisplayed(mMathDokuPreferences)) {
                    new TipLeaderboardCreateGame(LeaderboardOverviewActivity.this).show();
                }
            }
        });
    ...
    void setFilterSpinner(LeaderboardFilter leaderboardFilter) {
        ...
        spinner.setOnItemSelectedListener(new CreateLeaderboardFilterOnItemSelectedListener());
    }

    private class CreateLeaderboardFilterOnItemSelectedListener implements OnItemSelectedListener {
        @Override
    ...
    private class LeaderBoardRankUpdaterProgressDialogOnDismissListener implements OnDismissListener {
        @Override
        public void onDismiss(DialogInterface dialog) {
            mLeaderboardRankUpdaterProgressDialog = null;
    ...
    public void viewLeaderboardDetails(String mLeaderboardId) {
        ...
        if (getGamesClient() != null) {
            Intent intent = getGamesClient().getLeaderboardIntent(mLeaderboardId);
            if (intent != null) {
                ...
                startActivityForResult(intent, GooglePlayServiceFragmentActivity.RC_UNUSED);

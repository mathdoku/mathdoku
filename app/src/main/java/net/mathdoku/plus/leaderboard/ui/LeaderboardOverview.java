...
public class LeaderboardOverview extends android.support.v4.app.Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mLeaderboardFilter = LeaderboardFilter.values()[bundle.getInt(ARG_FILTER)];
    ...
    public void refresh() {
        ...
        LinearLayout linearLayout = (LinearLayout) mRootView.findViewById(R.id.leaderboard_list);
        ...
        mLeaderboardOverviewListItemForEmptyList = new LeaderboardOverviewListItem(this, mGridSize);
    ...
    public void setLeaderboardFilter(LeaderboardFilter leaderboardFilter) {
        ...
        mLeaderboardOverviewListItemForEmptyList.setVisibility(

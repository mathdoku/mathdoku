...
public class LeaderboardOverviewListItem {
    ...
    private enum LeaderboardOverviewListItemType {
        WITH_RANKING_INFORMATION,
        NO_RANKING_INFORMATION,
        PLACEHOLDER_EMPTY_OVERVIEW
    }

    /**
     * Creates a new instance of a {@link LeaderboardOverviewListItem} for a leaderboard.
     *
     * @param gridSize
    ...
    public LeaderboardOverviewListItem(final LeaderboardOverview leaderboardOverview,
        ...
        mLeaderboardListItemView = leaderboardOverview.getLayoutInflater()
        ...
        mLeaderboardId = leaderboardOverview.getResources()
                .getString(LeaderboardType.getResId(index));
    ...
    private void setupOnClickListener(LeaderboardOverview leaderboardOverview) {
        LinearLayout linearLayout = (LinearLayout) mLeaderboardListItemView.findViewById(
                R.id.leaderboard_section_layout);
    ...
    private class OnClickLeaderboardListener implements View.OnClickListener {
        ...
        public OnClickLeaderboardListener(LeaderboardOverview leaderboardOverview) {
        ...
        public void onClick(View view) {
            ...
            if (activity instanceof LeaderboardOverviewActivity) {
                ((LeaderboardOverviewActivity) activity).viewLeaderboardDetails(mLeaderboardId);
            }
        }
    }
    ...
    private class OnLongClickLeaderboardListener implements View.OnLongClickListener {
        ...
        public OnLongClickLeaderboardListener(LeaderboardOverview leaderboardOverview) {
            this.leaderboardOverview = leaderboardOverview;
        }

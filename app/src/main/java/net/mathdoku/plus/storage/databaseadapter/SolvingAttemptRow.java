...
public class SolvingAttemptRow {
    ...
    public int hashCode() {
        ...
        result = 31 * result + (int) (solvingAttemptDateCreated ^ solvingAttemptDateCreated >>> 32);
        result = 31 * result + (int) (solvingAttemptDateUpdated ^ solvingAttemptDateUpdated >>> 32);

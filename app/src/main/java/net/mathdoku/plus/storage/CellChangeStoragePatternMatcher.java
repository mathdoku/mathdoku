...
public class CellChangeStoragePatternMatcher {
    ...
    private static final String TAG = CellChangeStoragePatternMatcher.class.getName();
    ...
    public List<Integer> getPreviousPossibleValues() {
        ...
        if (!matcherInner.group(GROUP_PREVIOUS_POSSIBLE_VALUES)
                .isEmpty()) {
            for (String possible : matcherInner.group(GROUP_PREVIOUS_POSSIBLE_VALUES)
    ...
    public String debugLogOuter() {
        ...
        stringBuilder.append("#groups: ")
                ...
                .append("\n");
        stringBuilder.append("Cell change: ")
                .append(matcherOuter.group(GROUP_CELL_CHANGE));
    ...
    private class RelatedCellChangeSplitter {
        ...
        private void endGroup() {
            ...
            if (levelNestedGroup == 0) {
                ...
                String group = concatenatedStringOfCellChanges.substring(startPosGroup, index + 1);

...
public class LeaderboardRankRow {
    ...
    public String toString() {
        ...
        sb.append(", gridSize=")
                .append(gridSize);
        sb.append(", operatorsHidden=")
                .append(operatorsHidden);
        sb.append(", puzzleComplexity=")
                .append(puzzleComplexity);
        sb.append(", scoreOrigin=")
                .append(scoreOrigin);
        ...
        sb.append(", dateSubmitted=")
                .append(dateSubmitted);
        sb.append(", rankStatus=")
                .append(rankStatus);
        sb.append(", rank=")
                .append(rank);
        sb.append(", rankDisplay='")
                .append(rankDisplay)
                .append('\'');
    ...
    public int hashCode() {
        int result = id;
        result = 31 * result + (leaderboardId != null ? leaderboardId.hashCode() : 0);
        result = 31 * result + gridSize;
        result = 31 * result + (operatorsHidden ? 1 : 0);
        result = 31 * result + (puzzleComplexity != null ? puzzleComplexity.hashCode() : 0);
        result = 31 * result + (scoreOrigin != null ? scoreOrigin.hashCode() : 0);
        ...
        result = 31 * result + (rankDisplay != null ? rankDisplay.hashCode() : 0);
        result = 31 * result + (int) (dateLastUpdated ^ (dateLastUpdated >>> 32));
        return result;
    }
}

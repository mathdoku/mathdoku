...
class QueryHelper {
    ...
    static String joinStringsSeparatedWith(List<String> queryElements, String separator) {
    ...
    public static String joinBetweenParentheses(String operatorBetweenConditions,

...
/**
 * This class gathers data about grids and solving attempts with a given status and/or size.
 */
public class ArchiveSolvingAttemptSelector extends SolvingAttemptSelector {
    ...
    public static class LatestSolvingAttemptForGrid {
        ...
        public String toString() {
            final StringBuilder sb = new StringBuilder("LatestSolvingAttemptForGrid{");
            sb.append("gridId=")
                    .append(gridId);
    ...
    private int getGridIdFromCursor(Cursor cursor) {
        return cursor.getInt(cursor.getColumnIndexOrThrow(KEY_PROJECTION_GRID_ID));
    }

    private int getSolvingAttemptIdFromCursor(Cursor cursor) {
        return cursor.getInt(cursor.getColumnIndexOrThrow(KEY_PROJECTION_SOLVING_ATTEMPT_ID));
    }

    private int getSolvingAttemptStatusFromCursor(Cursor cursor) {
        return cursor.getInt(cursor.getColumnIndexOrThrow(KEY_PROJECTION_STATUS));
    }
    ...
    /**
     * Counts the number of solving attempts which will be retrieved by this selector. *
     *
     * @return The number of solving attempts which will be retrieved by this selector.
     */

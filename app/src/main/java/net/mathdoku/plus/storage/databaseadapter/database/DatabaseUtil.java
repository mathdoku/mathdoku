...
public class DatabaseUtil {
    ...
    /**
     * Encloses a string with back ticks (`). To be used for SQLite table and column names.
     *
     * @param string
     *         The string which needs to be prefixed and suffixed with back ticks.
     ...
     *
     * @param tableName
     *         The tableName which needs to be prefixed and suffixed with back ticks.
     * @param columnName
     *         The columnName which needs to be prefixed and suffixed with back ticks.
    ...
    /**
     * Encloses a string with quotes ('). To be used for string values in SQlite.
     *
     * @param string
     *         The string which needs to be prefixed and suffixed with quotes.
     ...
     *
     * @return The string representation of the current date and time as it is stored in SQLite.
     */
     ...
     * @return The string representation of the long value as it is stored in SQLite.
     */

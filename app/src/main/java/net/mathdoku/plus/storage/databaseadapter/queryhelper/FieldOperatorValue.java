...
/**
 * This class represents a field with an unquoted string value. Use class
 * FieldOperatorStringValue in case the string value on the right hand side has
...
public class FieldOperatorValue implements ConditionListElement {
	...
	public enum Operator {
		EQUALS("="), NOT_EQUALS("<>"), LESS_THAN("<"), BETWEEN("BETWEEN");

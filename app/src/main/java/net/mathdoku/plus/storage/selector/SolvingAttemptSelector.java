...
public abstract class SolvingAttemptSelector {
    ...
    public SolvingAttemptSelector(StatusFilter statusFilter, GridTypeFilter gridTypeFilter) {
    ...
    private SQLiteQueryBuilder getSqLiteQueryBuilder(DatabaseProjection databaseProjection) {
    ...
    protected String getJoinString() {
        ...
        stringBuilder.append(DatabaseUtil.stringBetweenBackTicks(GridDatabaseAdapter.TABLE_NAME));

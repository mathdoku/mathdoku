...
public class SolvingAttemptDatabaseAdapter extends DatabaseAdapter {
    ...
    public SolvingAttemptRow insert(SolvingAttemptRow solvingAttemptRow) {
        ...
        try {
            ...
            throw new DatabaseAdapterException("Cannot insert new solving attempt in database.", e);
        }
    ...
    private int getSavedWithRevisionFromCursor(Cursor cursor) {
        return cursor.getInt(cursor.getColumnIndexOrThrow(KEY_SAVED_WITH_REVISION));
    }
     ...
     *
     * @return The id of the solving attempt which was last played. -1 in case of an error.
     */
     ...
     *
     * @return The list of id's for all solving attempts which need to be converted.
     */

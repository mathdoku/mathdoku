...
public class ArchiveFragmentActivity extends AppFragmentActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (mActionBar != null) {
            ...
            mActionBar.setTitle(getResources().getString(R.string.archive_action_bar_title));
        ...
        if (intent != null) {
            ...
            if (bundle != null) {
                int solvingAttemptId = bundle.getInt(BUNDLE_KEY_SOLVING_ATTEMPT_ID);
                if (solvingAttemptId >= 0 && mArchiveFragmentStatePagerAdapter.getPositionOfGridId(
                        solvingAttemptId) >= 0) {
                    mMathDokuPreferences.setArchiveGridIdLastShowed(solvingAttemptId);
                }
            }
        }
    }
    ...
    protected void onResumeFragments() {
        ...
        boolean showStatusFilterNew = mMathDokuPreferences.isArchiveStatusFilterVisible();
        ...
        boolean showSizeFilterNew = mMathDokuPreferences.isArchiveSizeFilterVisible();
    ...
    @Override
    // Suppress warnings about cyclomatic complexity
    ...
    void setSizeSpinner() {
        ...
        final ArchiveFragmentGridSizeFilterSpinner archiveFragmentGridSizeFilterSpinner = new
        ...
        spinner.setSelection(archiveFragmentGridSizeFilterSpinner.indexOfSelectedGridSizeFilter());
    ...
    private void openHelpDialog() {
        ...
        new AlertDialog.Builder(this).setTitle(
                getResources().getString(R.string.action_archive) + " " + getResources().getString(
    ...
    private int getCurrentSelectedGridId() {
        if (mArchiveFragmentStatePagerAdapter != null && mViewPager != null) {
            return mArchiveFragmentStatePagerAdapter.getGridId(mViewPager.getCurrentItem());
        } else {
            return -1;
        }
    }
    ...
    /**
     * Get the solving attempt id of the grid which is currently displayed in the archive.
     *
     * @return The solving attempt id of the grid which is currently displayed in the archive.
     */
    ...
    private void selectGridId(int gridId) {
        ...
        int position = mArchiveFragmentStatePagerAdapter.getPositionOfGridId(gridId);
        ...
        if (position >= 0) {
            ...
            // Show last page
            mViewPager.setCurrentItem(mArchiveFragmentStatePagerAdapter.getCount() - 1);
        }
    }
    ...
    private class OnGridSizeFilterItemSelectedListener implements OnItemSelectedListener {
        ...
        public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
            ...
            GridTypeFilter newGridTypeFilter = archiveFragmentGridSizeFilterSpinner.get((int) id);
            ...
            if (mArchiveFragmentStatePagerAdapter.getSelectedSizeFilter() != newGridTypeFilter) {
                ...
                mArchiveFragmentStatePagerAdapter.setSizeFilter(newGridTypeFilter);

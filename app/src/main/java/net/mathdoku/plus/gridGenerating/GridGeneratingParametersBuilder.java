...
public class GridGeneratingParametersBuilder {
    ...
    public static GridGeneratingParametersBuilder createCopyOfGridGeneratingParameters
        ...
        return new GridGeneratingParametersBuilder().setGridType(
                ...
                .setMaxCagePermutations(gridGeneratingParameters.getMaxCagePermutations())
                .setMaxSingleCellCages(gridGeneratingParameters.getMaximumSingleCellCages());
    }

    public GridGeneratingParametersBuilder setGridType(GridType gridType) {
        throwErrorWhenDependingParameterHasBeenOverridden(isParameterDependentOnGridTypeOverridden,
    ...
    public GridGeneratingParametersBuilder setHideOperators(boolean hideOperators) {
    ...
    public GridGeneratingParametersBuilder setGeneratorVersionNumber(int generatorVersionNumber) {
    ...
    public String toString() {
        final StringBuilder sb = new StringBuilder("GridGeneratingParametersBuilder{");
        sb.append("gridType=")
                .append(gridType);
        sb.append(", hideOperators=")
                .append(hideOperators);
        sb.append(", puzzleComplexity=")
                .append(puzzleComplexity);
        sb.append(", generatorVersionNumber=")
                .append(generatorVersionNumber);
        sb.append(", gameSeed=")
                .append(gameSeed);
        sb.append(", maxCageSize=")
                .append(maxCageSize);
        sb.append(", maxCageResult=")
                .append(maxCageResult);
        sb.append(", maxCagePermutations=")
                .append(maxCagePermutations);
        sb.append(", maxSingleCellCages=")
                .append(maxSingleCellCages);
        sb.append(", isGridTypeSet=")
                .append(isGridTypeSet);
        sb.append(", isHideOperatorsSet=")
                .append(isHideOperatorsSet);
        sb.append(", isPuzzleComplexitySet=")
                .append(isPuzzleComplexitySet);
        sb.append(", isParameterDependentOnPuzzleComplexityOverridden=")
                .append(isParameterDependentOnPuzzleComplexityOverridden);
        sb.append(", isParameterDependentOnGridTypeOverridden=")
                .append(isParameterDependentOnGridTypeOverridden);
        sb.append('}');
        return sb.toString();
    }
}
...
public class CellCoordinates {
    ...
    public CellCoordinates(int row, int column) {
        if (row < 0) {
            throw new IllegalArgumentException("Row should be greater than or equal to 0.");
        }
        if (column < 0) {
            throw new IllegalArgumentException("Column should be greater than or equal to 0.");
        }
        this.row = row;
        this.column = column;
    }

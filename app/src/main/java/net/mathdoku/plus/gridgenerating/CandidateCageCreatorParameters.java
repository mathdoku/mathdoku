...
public class CandidateCageCreatorParameters {
	...
	public CandidateCageCreatorParameters setGridGeneratingParameters(
	...
	public CandidateCageCreatorParameters setCorrectValueMatrix(
			Matrix<Integer> correctValueMatrix) {
		this.correctValueMatrix = correctValueMatrix;
		overlappingSubsetChecker = new OverlappingSubsetChecker(
				correctValueMatrix);
		return this;
	}

	public CandidateCageCreatorParameters setCageIdMatrix(

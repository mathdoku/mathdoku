...
public class CellPainter extends BorderPainter {
    ...
    public CellPainter() {
        ...
        mUnusedBorderPaint.setPathEffect(new DashPathEffect(new float[]{2, 2}, 0));
    ...
    protected void setBorderSizes(boolean thin) {
        if (thin) {
            ...
            mInvalidBorderPaint.setStrokeWidth(BorderPainter.BORDER_STROKE_WIDTH_NORMAL);
            mDuplicateBorderPaint.setStrokeWidth(BorderPainter.BORDER_STROKE_WIDTH_NORMAL);
            mRevealedBorderPaint.setStrokeWidth(BorderPainter.BORDER_STROKE_WIDTH_NORMAL);
            mSelectedBorderPaint.setStrokeWidth(BorderPainter.BORDER_STROKE_WIDTH_NORMAL);
        } else {
            mUnusedBorderPaint.setStrokeWidth(BorderPainter.BORDER_STROKE_HAIR_LINE);
            mInvalidBorderPaint.setStrokeWidth(BorderPainter.BORDER_STROKE_WIDTH_THICK);
            mDuplicateBorderPaint.setStrokeWidth(BorderPainter.BORDER_STROKE_WIDTH_THICK);
            mRevealedBorderPaint.setStrokeWidth(BorderPainter.BORDER_STROKE_WIDTH_THICK);
            mSelectedBorderPaint.setStrokeWidth(BorderPainter.BORDER_STROKE_WIDTH_THICK);
        }
    }
     ...
     *
     * @return The paint for borders between two cells belonging to the same cage.
     */
     ...
     *
     * @return The paint for the background of a cell containing an invalid value.
     */
     ...
     *
     * @return The paint for the background of a cell containing a duplicate value.
     */

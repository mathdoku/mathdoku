...
public class Preferences {
    ...
    private static final String PUZZLE_PARAMETER_GRID_SIZE_DEFAULT = GridType.GRID_4X4.toString();
    ...
    public static final String STATISTICS_SETTING_CHART_DESCRIPTION_VISIBLE =
    ...
    public static Preferences getInstance(Context context) {
        if (mPreferencesSingletonInstance == null) {
            ...
            // created.
            mPreferencesSingletonInstance = new ObjectsCreator().createPreferences(context);
        }
    ...
    private void upgradeToVersion586(int previousInstalledVersion, int currentVersion, Editor editor) {
        ...
        if (previousInstalledVersion < 586 && currentVersion >= 586) {
            editor.putBoolean(PUZZLE_SETTING_CLEAR_MAYBES, PUZZLE_SETTING_CLEAR_MAYBES_DEFAULT)
                    ...
                    .putInt(SWIPE_VALID_MOTION_COUNTER, SWIPE_DIGIT_COUNTER_DEFAULT)
    ...
    /**
     * Renames preferences with pattern below: Tip.Tip.TipPreference.DisplayAgain.DisplayAgain
    ...
    private void renameTipDisplayAgainVersion599(Editor editor) {
        ...
        for (String preference : mSharedPreferences.getAll()
                .keySet()) {
    ...
    public int getCurrentInstalledVersion() {
        return mSharedPreferences.getInt(APP_CURRENT_VERSION, APP_CURRENT_VERSION_DEFAULT);
    }

    /**
     * Checks whether it should be prevented that the screen get locked while playing.
     *
    ...
    public void setTipDoNotDisplayAgain(String tip) {
        Editor editor = mSharedPreferences.edit();
        editor.putBoolean(TipDialog.getPreferenceStringDisplayTipAgain(tip), false);
        editor.apply();
    }
    ...
    public boolean getTipDisplayAgain(String tip) {
        return mSharedPreferences.getBoolean(TipDialog.getPreferenceStringDisplayTipAgain(tip),
    ...
    public long getTipLastDisplayTime(String tip) {
        return mSharedPreferences.getLong(TipDialog.getPreferenceStringLastDisplayTime(tip),
     ...
     *
     * @return True in case duplicate digits should be shown in the grid. False otherwise.
     */
    public boolean isDuplicateDigitHighlightVisible() {
        return mSharedPreferences.getBoolean(PUZZLE_SETTING_DUPLICATE_DIGITS_VISIBLE,
                                             PUZZLE_SETTING_DUPLICATE_DIGITS_VISIBLE_DEFAULT);
    }
     ...
     *
     * @return True in case cages having bad math should be highlighted. False otherwise.
     */
    public boolean isBadCageMathHighlightVisible() {
        return mSharedPreferences.getBoolean(PUZZLE_SETTING_BAD_CAGE_MATHS_VISIBLE,
                                             PUZZLE_SETTING_BAD_CAGE_MATHS_VISIBLE_DEFAULT);
    }

    /**
     * Checks whether a description has to be shown below a chart in the statistics activity.
     *
     * @return True in case the charts descriptions have to be shown. False otherwise.
     */
    public boolean isStatisticsChartDescriptionVisible() {
        return mSharedPreferences.getBoolean(STATISTICS_SETTING_CHART_DESCRIPTION_VISIBLE,
                                             STATISTICS_SETTING_CHART_DESCRIPTION_VISIBLE_DEFAULT);
    }

    /**
     * Checks whether a description has to be shown below a chart in the archive activity.
     *
     * @return True in case the charts descriptions have to be shown. False otherwise.
     */
    public boolean isArchiveChartDescriptionVisible() {
        return mSharedPreferences.getBoolean(ARCHIVE_SETTING_CHART_DESCRIPTION_VISIBLE,
                                             ARCHIVE_SETTING_CHART_DESCRIPTION_VISIBLE_DEFAULT);
    }
    ...
    public boolean isArchiveAvailable() {
        return mSharedPreferences.getBoolean(ARCHIVE_AVAILABLE, ARCHIVE_AVAILABLE_DEFAULT);
    }
    ...
    public boolean isStatisticsAvailable() {
        return mSharedPreferences.getBoolean(STATISTICS_AVAILABLE, STATISTICS_AVAILABLE_DEFAULT);
    }
     ...
     *
     * @param statusFilter
     *         The status filter which has to be saved as last selected in the archive.
     */
    public void setArchiveStatusFilterLastValueUsed(StatusFilter statusFilter) {
        Editor editor = mSharedPreferences.edit();
        editor.putString(ARCHIVE_STATUS_FILTER_LAST_VALUE, statusFilter.toString());
        editor.apply();
    }
     ...
     *         The size filter which has to be saved as last selected in the archive.
     */
    public void setArchiveSizeFilterLastValueUsed(GridTypeFilter gridTypeFilter) {
        Editor editor = mSharedPreferences.edit();
        editor.putString(ARCHIVE_GRID_TYPE_FILTER_LAST_VALUE, gridTypeFilter.toString());
        editor.apply();
    }
    ...
    /**
     * Initializes the counters with current values as stored in the preferences.
     */
    private void initializeCounters() {
        if (counters == null) {
            ...
            counters[SWIPE_DIGIT_2_COUNTER_ID] = mSharedPreferences.getInt(SWIPE_DIGIT_2_COUNTER,
                                                                           SWIPE_DIGIT_COUNTER_DEFAULT);
            counters[SWIPE_DIGIT_3_COUNTER_ID] = mSharedPreferences.getInt(SWIPE_DIGIT_3_COUNTER,
                                                                           SWIPE_DIGIT_COUNTER_DEFAULT);
            counters[SWIPE_DIGIT_4_COUNTER_ID] = mSharedPreferences.getInt(SWIPE_DIGIT_4_COUNTER,
                                                                           SWIPE_DIGIT_COUNTER_DEFAULT);
            counters[SWIPE_DIGIT_5_COUNTER_ID] = mSharedPreferences.getInt(SWIPE_DIGIT_5_COUNTER,
                                                                           SWIPE_DIGIT_COUNTER_DEFAULT);
            counters[SWIPE_DIGIT_6_COUNTER_ID] = mSharedPreferences.getInt(SWIPE_DIGIT_6_COUNTER,
                                                                           SWIPE_DIGIT_COUNTER_DEFAULT);
            counters[SWIPE_DIGIT_7_COUNTER_ID] = mSharedPreferences.getInt(SWIPE_DIGIT_7_COUNTER,
                                                                           SWIPE_DIGIT_COUNTER_DEFAULT);
            counters[SWIPE_DIGIT_8_COUNTER_ID] = mSharedPreferences.getInt(SWIPE_DIGIT_8_COUNTER,
                                                                           SWIPE_DIGIT_COUNTER_DEFAULT);
    ...
    /**
     * Get the number of valid swipe motions which have successfully been completed.
     *
     * @return The number of valid swipe motions which have successfully been completed.
     */
     ...
     *
     * @return The (updated) number of times an invalid swipe motion has been completed.
     */
    ...
    /**
     * Get the maximum number of games which should be shown in a elapsed-time-chart.
     *
     ...
     *
     * @return The (updated) number of times the input mode has been set to copy mode.
     */
    @SuppressWarnings("UnusedReturnValue")
    ...
    public void commitCounters() {
        if (counters != null) {
            ...
            editor.putInt(SWIPE_DIGIT_4_COUNTER, counters[SWIPE_DIGIT_4_COUNTER_ID]);
            editor.putInt(SWIPE_DIGIT_5_COUNTER, counters[SWIPE_DIGIT_5_COUNTER_ID]);
            editor.putInt(SWIPE_DIGIT_6_COUNTER, counters[SWIPE_DIGIT_6_COUNTER_ID]);
            editor.putInt(SWIPE_DIGIT_7_COUNTER, counters[SWIPE_DIGIT_7_COUNTER_ID]);
            editor.putInt(SWIPE_DIGIT_8_COUNTER, counters[SWIPE_DIGIT_8_COUNTER_ID]);
            editor.putInt(SWIPE_DIGIT_9_COUNTER, counters[SWIPE_DIGIT_9_COUNTER_ID]);
            editor.putInt(SWIPE_VALID_MOTION_COUNTER, counters[SWIPE_VALID_MOTION_COUNTER_ID]);
            editor.putInt(SWIPE_INVALID_MOTION_COUNTER, counters[SWIPE_INVALID_MOTION_COUNTER_ID]);
            editor.commit();
        }
    }
    ...
    public void setPuzzleParameterComplexity(PuzzleComplexity puzzleComplexity) {
        Editor editor = mSharedPreferences.edit();
        editor.putString(PUZZLE_PARAMETER_COMPLEXITY, puzzleComplexity.toString());
        editor.apply();
    }
     ...
     *
     * @return True in case the outer swipe circle is never visible. False otherwise.
     */
    public boolean isOuterSwipeCircleNeverVisible() {
        return mSharedPreferences.getString(PUZZLE_SETTING_OUTER_SWIPE_CIRCLE,
                                            PUZZLE_SETTING_OUTER_SWIPE_CIRCLE_DEFAULT)
                .equals(PUZZLE_SETTING_OUTER_SWIPE_CIRCLE_NEVER_VISIBLE);
    }
    ...
    /**
     * Checks whether the checkbox "Hide till next top score is achieved" checked by default.
     *
     * @return True in case checkbox is enabled by default. False otherwise.
     */
    public boolean isHideTillNextTopScoreAchievedChecked() {
        return mSharedPreferences.getBoolean(PUZZLE_HIDE_GOOGLE_PLUS_SIGN_IN_TILL_NEXT_TOP_SCORE,
                                             PUZZLE_HIDE_GOOGLE_PLUS_SIGN_IN_TILL_NEXT_TOP_SCORE_DEFAULT);
    }
    ...
    public void setHideTillNextTopScoreAchievedChecked(boolean checked) {
        mSharedPreferences.edit()
                .putBoolean(PUZZLE_HIDE_GOOGLE_PLUS_SIGN_IN_TILL_NEXT_TOP_SCORE, checked)
                .apply();
    }

    /**
     * Get the tab which was displayed last time the leaderboards were displayed.
     *
    ...
    /**
     * Get the last value used for the leaderboard filter in the leaderboards overview.
     *
    ...
    /**
     * Set the last value used for the leaderboard filter in the leaderboards overview.
     *
     * @param leaderboardFilter
     *         The leaderboard filter which was last used.
     */
    public void setLeaderboardFilterLastValueUsed(LeaderboardFilter leaderboardFilter) {
        Editor editor = mSharedPreferences.edit();
        editor.putString(LEADERBOARD_FILTER_LAST_VALUE, leaderboardFilter.toString());
        editor.apply();
    }
    ...
    public void increaseLeaderboardsDetailsViewed() {
        Editor editor = mSharedPreferences.edit();
        editor.putInt(LEADERBOARD_DETAILS_VIEWED_COUNTER, getLeaderboardsDetailsViewed() + 1);
        editor.apply();
    ...
    public void increaseLeaderboardsGamesCreated() {
        Editor editor = mSharedPreferences.edit();
        editor.putInt(LEADERBOARD_GAMES_CREATED_COUNTER, getLeaderboardsGamesCreated() + 1);
        editor.apply();

    }

    /**
     * Get the number of times the leaderboards overview is started to be viewed.
     *
     * @return The number of times the leaderboards overview is started to be viewed.
     */
    ...
    public void increaseLeaderboardsOverviewViewed() {
        Editor editor = mSharedPreferences.edit();
        editor.putInt(LEADERBOARD_OVERVIEW_VIEWED_COUNTER, getLeaderboardsOverviewViewed() + 1);
        editor.apply();

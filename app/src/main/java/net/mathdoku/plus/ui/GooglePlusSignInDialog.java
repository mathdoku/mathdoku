...
public class GooglePlusSignInDialog extends Dialog implements android.view.View.OnClickListener {
     ...
     */
    public GooglePlusSignInDialog(AppFragmentActivity appFragmentActivity, Listener listener) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ((TextView) findViewById(R.id.google_plus_login_dialog_message)).setText(mMessageResID);
        findViewById(R.id.sign_in_button).setOnClickListener(this);
        findViewById(R.id.sign_in_cancel_button).setOnClickListener(this);

        mHideTillNextTopScoreAchievedCheckbox = (CheckBox) findViewById(
                R.id.hide_till_next_top_score_achieved_checkbox);
        mHideTillNextTopScoreAchievedCheckbox.setVisibility(mCheckboxIsVisible ? View.VISIBLE : View.GONE);
    ...
    public void onClick(View v) {
        if (mHideTillNextTopScoreAchievedCheckbox != null && mHideTillNextTopScoreAchievedCheckbox.getVisibility() ==
                View.VISIBLE) {
            Preferences.getInstance(mAppFragmentActivity)
                    .setHideTillNextTopScoreAchievedChecked(mHideTillNextTopScoreAchievedCheckbox.isChecked());
        }
     ...
     * @return The GooglePlusSignInDialog so the method can be chained.
     */
    public GooglePlusSignInDialog displayCheckboxHideTillNextTopScoreAchieved(boolean checked) {

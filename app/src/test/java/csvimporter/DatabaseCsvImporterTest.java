...
public class DatabaseCsvImporterTest {
	...
	@Test(expected = CsvImporterException.class)
	public void importFile_DatabaseAdapterIsNull_ThrowsCsvImporterException()
			throws Exception {
		new DatabaseCsvImporter(getPathToFile("CsvImporterTest_grid.csv"), null)
				.importFile();
	}
	...
	public void importFile_FileDoesNotExist_ThrowsCsvImporterException()
			throws Exception {
		new DatabaseCsvImporter(getPathToFile("some non existing file.csv"),
				new GridDatabaseAdapter()).importFile();
	}

	@Test(expected = CsvImporterException.class)
	public void importFile_FileContainsAStringWhereAnIntegerWasExpected_ThrowsCsvImporterException()
			throws Exception {
		new DatabaseCsvImporter(getPathToFile("grid_with_error.csv"),
				new GridDatabaseAdapter()).importFile();
	}

	@Test
	public void importFile_Grid_ImportedWithoutError() throws Exception {
		new DatabaseCsvImporter(getPathToFile("grid.csv"),
				new GridDatabaseAdapter()).importFile();
	}

	@Test
	public void importFile_LeaderboardRank_ImportedWithoutError()
			throws Exception {
	...
	@Test
	public void importFile_SolvingAttempt_ImportedWithoutError()
			throws Exception {
		new DatabaseCsvImporter(getPathToFile("solving_attempt.csv"),
				new SolvingAttemptDatabaseAdapter()).importFile();
	}

	@Test
	public void importFile_Statistics_ImportedWithoutError() throws Exception {
		new DatabaseCsvImporter(getPathToFile("statistics.csv"),

...
public class GridConverterTest {
	...
	private class GridConverterWithMockedDialog extends GridConverter {
		...
		public GridConverterWithMockedDialog(PuzzleFragmentActivity activity,
	...
	@Test
	public void constructor_VersionNotIncreased_NoDialogPresented()
			throws Exception {
		GridConverterWithMockedDialog gridConverterWithMockedDialog = new GridConverterWithMockedDialog(
				puzzleFragmentActivity, CURRENT_VERSION_598,
				CURRENT_VERSION_598);

		assertThat(gridConverterWithMockedDialog.progressDialogCreated,
				is(false));
	}

	@Test
	public void constructor_VersionIncreased_NoDialogPresented()
			throws Exception {
		GridConverterWithMockedDialog gridConverterWithMockedDialog = new GridConverterWithMockedDialog(
	...
	public void attachToActivity_AttachActivityAgainWhileDialogStillVisible_SameInstanceReturned()
		...
		assertThat(gridConverterWithMockedDialog.progressDialogCreated,
				is(true));
		assertThat(gridConverterWithMockedDialog.currentProgressDialog,
				is(sameInstance(initialProgressDialog)));
	}
	...
	private List<Integer> setSolvingAttemptDatabaseAdapterMockToReturnIds(int...solvingAttemptIds) {
		...
		when(solvingAttemptDatabaseAdapterMock.getAllToBeConverted())
				.thenReturn(solvingAttemptsToBeConverted);
	...
	public void execute() throws Exception {
		...
		verify(gridConverterWithMockedDialog.currentProgressDialog, times(idsToBeReturned.size())).incrementProgressBy(1);

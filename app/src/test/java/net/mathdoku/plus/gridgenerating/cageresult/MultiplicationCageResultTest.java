...
public class MultiplicationCageResultTest {
	...
	public void tryToCreate_CorrectNumberOfValues_CageResultCreated()
			throws Exception {
		MultiplicationCageResult multiplicationCageResult = MultiplicationCageResult
				.tryToCreate(1, 3);
	...
	public void testGetResult_10Values_CorrectResult() throws Exception {
		MultiplicationCageResult multiplicationCageResult = MultiplicationCageResult
				.tryToCreate(8, 4, 5, 3, 2, 9, 7, 1, 6);
		assertThat(multiplicationCageResult.getResult(), is(1 * 2 * 3 * 4 * 5
				* 6 * 7 * 8 * 9));
	}
}

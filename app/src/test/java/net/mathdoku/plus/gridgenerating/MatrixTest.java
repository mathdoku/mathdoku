...
public class MatrixTest {
	...
	private Matrix<Item> createMatrixWithEntriesOnDiagonalTopLeftToBottomRightFilledWith(
			Item diagonalItem) {
	...
	@Test
	public void createTransposedMatrix_OriginalMatrixTransposed_AllItemsTransposed()
			throws Exception {
		Matrix<Item> transposedMatrix = matrix.createTransposedMatrix();
		for (int row = 0; row < matrixSize; row++) {
			for (int col = 0; col < matrixSize; col++) {
				assertThat(matrix.get(row, col),
						is(transposedMatrix.get(col, row)));
			}
		}
	}
	...
	@Test
	public void containsInvalidCellCoordinates_GivenCoordinatesAreAllValid_NoInvalidCellCoordinatesFound()
			throws Exception {
		CellCoordinates[] cellCoordinates = new CellCoordinates[matrixSize
				* matrixSize];
		int index = 0;
		for (int row = 0; row < matrixSize; row++) {
			for (int col = 0; col < matrixSize; col++) {
		...
		assertThat(matrix.containsInvalidCellCoordinates(cellCoordinates),
				is(false));
	}

	@Test
	public void containsInvalidCellCoordinates_GivenCoordinatesHaveRowTooSmall_InvalidCellCoordinatesFound()
			throws Exception {
		assertThat(
				matrix.containsInvalidCellCoordinates(CellCoordinates.EMPTY),
				is(true));
	}

	@Test
	public void containsInvalidCellCoordinates_GivenCoordinatesHaveRowTooBig_InvalidCellCoordinatesFound()
			throws Exception {
		assertThat(matrix.containsInvalidCellCoordinates(new CellCoordinates(
				matrixSize, 0)), is(true));
	}
	...
	@Test
	public void containsInvalidCellCoordinates_GivenCoordinatesHaveColumnTooBig_InvalidCellCoordinatesFound()
			throws Exception {
		assertThat(matrix.containsInvalidCellCoordinates(new CellCoordinates(0,
				matrixSize)), is(true));
	}

	@Test
	public void containsInvalidCellCoordinates_SomeOfGivenCoordinatesAreInvalid_InvalidCellCoordinatesFound()
			throws Exception {
		CellCoordinates validCellCoordinates1 = new CellCoordinates(0, 0);
		CellCoordinates validCellCoordinates2 = new CellCoordinates(
				matrixSize - 1, matrixSize - 1);
		CellCoordinates invalidCellCoordinates = new CellCoordinates(
				matrixSize, matrixSize);
		assertThat(matrix.containsInvalidCellCoordinates(validCellCoordinates1,
				validCellCoordinates2, invalidCellCoordinates), is(true));
	}

	@Test
	public void setValueToAllCellCoordinates_SetAllEntriesOnDiagonalTopLeftToBottomRight_OnlyEntriesOnDiagonalTopLeftToBottomRightAreChanged()
			throws Exception {
		...
		matrix.setValueToAllCellCoordinates(diagonalItem,
				diagonalCellCoordinates);
	...
	@Test
	public void setValueToCellCoordinates_SetASpecificEntry_OnlyThisEntryIsChanged()
			throws Exception {
		Item someItem = new Item(99, 99);
		int itemRow = 2;
		int itemColumn = 1;

		matrix.setValueToCellCoordinates(someItem, new CellCoordinates(itemRow,
				itemColumn));
		assertThatValueIsSetToRowColumnOnly(someItem, itemRow, itemColumn);
	}

	private void assertThatValueIsSetToRowColumnOnly(Item someItem,
	...
	@Test(expected = IndexOutOfBoundsException.class)
	public void setValueToRowColumn_RowTooSmall_IndexOutOfBoundsException()
			throws Exception {
		matrix.setValueToRowColumn(emptyItem, -1, 0);
	}

	@Test(expected = IndexOutOfBoundsException.class)
	public void setValueToRowColumn_RowTooBig_IndexOutOfBoundsException()
			throws Exception {
		matrix.setValueToRowColumn(emptyItem, matrixSize, 0);
	}

	@Test(expected = IndexOutOfBoundsException.class)
	public void setValueToRowColumn_ColumnTooSmall_IndexOutOfBoundsException()
			throws Exception {
		matrix.setValueToRowColumn(emptyItem, 0, -1);
	}

	@Test(expected = IndexOutOfBoundsException.class)
	public void setValueToRowColumn_ColumnTooBig_IndexOutOfBoundsException()
			throws Exception {
	...
	public void getColumn() throws Exception {
		...
		assertThat((ArrayList<Item>) matrix.getColumn(columnToCheck),
				is(expectedItemsInColumn));
	}

	@Test
	public void countValueInColumn_ColumnContainsEmptyValues_CountedTheEmptyCells()
			throws Exception {
	...
	@Test
	public void containsNonEmptyCell_CellCoordinatesToCheckContainEmptyValues_NullValuesFound()
			throws Exception {
		...
		assertThat(matrix.containsNonEmptyCell(cellCoordinatesToCheck),
				is(true));
	}

	@Test
	public void containsNonEmptyCell_MatrixWithNullValues_NullValuesFound()
			throws Exception {
		CellCoordinates[] cellCoordinatesToCheck = new CellCoordinates[] {
				// Containing non empty values
				new CellCoordinates(0, 1), new CellCoordinates(0, 2),
				new CellCoordinates(1, 0), new CellCoordinates(2, 0), };
		assertThat(matrix.containsNonEmptyCell(cellCoordinatesToCheck),
				is(true));
	}

	@Test(expected = IndexOutOfBoundsException.class)
	public void isEmpty_RowTooSmall_IndexOutOfBoundsException()
			throws Exception {
		matrix.isEmpty(-1, 0);
	}
	...
	@Test(expected = IndexOutOfBoundsException.class)
	public void isEmpty_ColumnTooSmall_IndexOutOfBoundsException()
			throws Exception {
		matrix.isEmpty(0, -1);
	}

	@Test(expected = IndexOutOfBoundsException.class)
	public void isEmpty_ColumnTooBig_IndexOutOfBoundsException()
			throws Exception {
	...
	@Test(expected = IndexOutOfBoundsException.class)
	public void isNotEmpty_RowTooSmall_IndexOutOfBoundsException()
			throws Exception {
		matrix.isNotEmpty(-1, 0);
	}

	@Test(expected = IndexOutOfBoundsException.class)
	public void isNotEmpty_RowTooBig_IndexOutOfBoundsException()
			throws Exception {
		matrix.isNotEmpty(matrixSize, 0);
	}

	@Test(expected = IndexOutOfBoundsException.class)
	public void isNotEmpty_ColumnTooSmall_IndexOutOfBoundsException()
			throws Exception {
		matrix.isNotEmpty(0, -1);
	}

	@Test(expected = IndexOutOfBoundsException.class)
	public void isNotEmpty_ColumnTooBig_IndexOutOfBoundsException()
			throws Exception {
	...
	@Test
	public void isNotEmpty_NonEmptyRowColumn_NotEmptyDetected()
			throws Exception {
		assertThat(matrix.isNotEmpty(1, 0), is(true));
	}

	@Test
	public void getCellCoordinatesForFirstEmptyCell_FirstCellIsEmpty_CellRow0AndColumn0Found()
			throws Exception {
		CellCoordinates expectedCellCoordinatesFirstCellEmpty = new CellCoordinates(
				0, 0);
		assertThat(matrix.getCellCoordinatesForFirstEmptyCell(),
				is(expectedCellCoordinatesFirstCellEmpty));
	}

	@Test
	public void getCellCoordinatesForFirstEmptyCell_MiddleCellIsEmpty_CellRow0AndColumn0Found()
			throws Exception {
	...
	@Test
	public void getCellCoordinatesForFirstEmptyCell_LastCellIsEmpty_CellRow0AndColumn0Found()
			throws Exception {
	...
	public void isTransposed_TransposedMatrix_IsTransposed() throws Exception {
		assertThat(matrix.createTransposedMatrix().isTransposed(), is(true));
	}

	@Test
	public void isTransposed_DoubleTransposedMatrix_IsNotTransposed()
			throws Exception {
		assertThat(matrix

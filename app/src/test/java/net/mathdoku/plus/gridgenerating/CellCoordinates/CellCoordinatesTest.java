...
public class CellCoordinatesTest {
	...
	private static final CellCoordinates validCellCoordinates1 = new CellCoordinates(
			rowValidCellCoordinates, columnValidCellCoordinates);
	private static final CellCoordinates validCellCoordinates2 = new CellCoordinates(
			rowValidCellCoordinates, columnValidCellCoordinates);
	private static final CellCoordinates validCellCoordinates3 = new CellCoordinates(
			rowValidCellCoordinates, columnValidCellCoordinates);
	private static final CellCoordinates otherValidCellCoordinates = new CellCoordinates(
			rowValidCellCoordinates + 1, columnValidCellCoordinates);
	...
	public void constructor_RowTooSmall_throwsIllegalArgumentException()
			throws Exception {
		new CellCoordinates(-1, 0);
	}

	@Test(expected = IllegalArgumentException.class)
	public void constructor_ColumnTooSmall_throwsIllegalArgumentException()
			throws Exception {
	...
	@Test
	public void getColumn_ValidCellCoordinates_ColumnIsCorrect()
			throws Exception {
		assertThat(validCellCoordinates1.getColumn(),
				is(columnValidCellCoordinates));
	}
	...
	public void equals_Reflexive_True() throws Exception {
		assertThat(validCellCoordinates1.equals(validCellCoordinates1),
				is(true));
	}
	...
	public void equals_WrongType_False() throws Exception {
		...
		assertThat(validCellCoordinates1.equals(new someOtherObject()),
				is(false));
	}
	...
	public void equals_Symmetric_True() throws Exception {
		assertThat(validCellCoordinates1.equals(validCellCoordinates2),
				is(true));
		assertThat(validCellCoordinates2.equals(validCellCoordinates1),
				is(true));
	}
	...
	public void equals_Transitive_True() throws Exception {
		assertThat(validCellCoordinates1.equals(validCellCoordinates2),
				is(true));
		assertThat(validCellCoordinates2.equals(validCellCoordinates3),
				is(true));
		assertThat(validCellCoordinates1.equals(validCellCoordinates3),
				is(true));
	}

	@Test
	public void equals_ConsistentWhenMultipleTimesCalled_True()
			throws Exception {
		for (int i = 0; i < 10; i++) {
			assertThat(validCellCoordinates1.equals(validCellCoordinates2),
					is(true));
			assertThat(validCellCoordinates1.equals(otherValidCellCoordinates),
					is(false));
		}
	}

	@Test
	public void hashCode_ConsistentWhenMultipleTimesCalled_True()
			throws Exception {
	...
	public void hashCode_TwoEqualObjects_SameHashCode() throws Exception {
		assertThat(validCellCoordinates1.hashCode(),
				is(validCellCoordinates2.hashCode()));
	}

	@Test
	public void hashCode_TwoDifferentsObjects_DifferentHashCode()
			throws Exception {
		assertThat(
				"When failing method hashcode might need further optimizations to calculate different results for different objects.",
				validCellCoordinates1.hashCode(),
				is(not(otherValidCellCoordinates.hashCode())));
	}
}

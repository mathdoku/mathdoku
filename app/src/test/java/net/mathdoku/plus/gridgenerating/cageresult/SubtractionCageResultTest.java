...
public class SubtractionCageResultTest {
	...
	public void tryToCreate_CorrectNumberOfValues_CageResultCreated()
			throws Exception {
		assertThat(SubtractionCageResult.tryToCreate(3, 9),
				is(not(nullValue())));
	}

	@Test
	public void testGetResult_2ValuesOrderedAscending_CorrectResult()
			throws Exception {
		SubtractionCageResult subtractionCageResult = SubtractionCageResult
				.tryToCreate(2, 8);
		assertThat(subtractionCageResult.getResult(), is(8 - 2));
	}

	@Test
	public void testGetResult_2ValuesOrderedDescending_CorrectResult()
			throws Exception {
		SubtractionCageResult subtractionCageResult = SubtractionCageResult
				.tryToCreate(6, 3);

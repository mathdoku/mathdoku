...
public class DivisionCageResultTest {
    ...
    @Test
    public void tryToCreate_ValuesOrderedAscendingCanBeDivided_CageResultCreated() throws Exception {
        assertThat(DivisionCageResult.tryToCreate(3, 9), is(not(nullValue())));
    }

    @Test
    public void tryToCreate_ValuesOrderedDescendingCanBeDivided_CageResultCreated() throws Exception {
        assertThat(DivisionCageResult.tryToCreate(8, 2), is(not(nullValue())));
    }

    @Test
    public void testGetResult_ValuesOrderedAscendingCanBeDivided_CorrectResult() throws Exception {
        DivisionCageResult divisionCageResult = DivisionCageResult.tryToCreate(2, 8);
        assertThat(divisionCageResult.getResult(), is(8 / 2));
    }

    @Test
    public void testGetResult_ValuesOrderedDescendingCanBeDivided_CorrectResult() throws Exception {
        DivisionCageResult divisionCageResult = DivisionCageResult.tryToCreate(6, 3);

...
public class CageTypeTest {
	...
	public void constructor_CageTypeMatrixNull_CageTypeNotCreated()
			throws Exception {
		new CageType(null);
	}

	@Test(expected = IllegalArgumentException.class)
	public void constructor_CageTypeMatrixNoRows_CageTypeNotCreated()
			throws Exception {
		new CageType(new boolean[][] {});
	}

	@Test(expected = IllegalArgumentException.class)
	public void constructor_CageTypeMatrixOneRowButNoColumns_CageTypeNotCreated()
			throws Exception {
		new CageType(new boolean[][] { {} });
	}

	@Test(expected = IllegalArgumentException.class)
	public void constructor_CageTypeMatrixRowsOfDifferentLength_CageTypeNotCreated()
			throws Exception {
		new CageType(new boolean[][] { { true, false }, { true } });
	}

	@Test(expected = IllegalArgumentException.class)
	public void constructor_CageTypeMatrixEmpty_CageTypeNotCreated()
			throws Exception {
	...
	public void new_CreateCageTypeSingleCell_CageTypeCreated() throws Exception {
		assertThat(new CageType(new boolean[][] { { true } }),
				is(notNullValue()));
	}
	...
	@Test
	public void new_CreateCageTypeExampleWithUnusedBorders_EqualsCageTypeExampleWithNoUnusedBorders()
			throws Exception {
		CageType cageTypeExampleUnusedBorder = new CageType(
				cageTypeMatrixExampleWithNoUnusedBorders);
		assertThat(cageTypeExampleUnusedBorder, is(notNullValue()));
		assertThat(cageTypeExampleUnusedBorder, equalTo(cageTypeExample));
	}

	@Test
	public void new_CreateCageTypeWithBigUnusedBorders_CageTypeCreated()
			throws Exception {
		...
		CageType cageTypeWithBigUnusedBorders = new CageType(
				cageTypeMatrixWithBigUnusedBorders);
	...
	public void getExtendedCageTypeMatrix() throws Exception {
		boolean[][] extendedCageType = cageTypeExample
				.getExtendedCageTypeMatrix();
		assertThat(extendedCageType,
				equalTo(cageTypeMatrixExampleWithUnusedBorders));
	}
	...
	@Test
	public void getCellCoordinatesOfAllCellsInCage_CageTypeCanBeShiftedToOriginLocation_EmptyCellCoordinates()
			throws Exception {

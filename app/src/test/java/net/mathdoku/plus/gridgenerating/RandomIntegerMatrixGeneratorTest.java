...
public class RandomIntegerMatrixGeneratorTest {
    ...
    @Test
    public void getMatrix_NoRepetitionsNeeded_MatrixGenerated() throws Exception {
    ...
    @Test
    public void getMatrix_WithMaximumRepetitionsAllowed_MatrixGenerated() throws Exception {

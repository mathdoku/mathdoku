...
public class CandidateCageCreatorTest {
    ...
    private final CellCoordinates validCellCoordinates1 = new CellCoordinates(0, 0);
    private final CellCoordinates validCellCoordinates2 = new CellCoordinates(1, 1);
    private final CellCoordinates invalidCellCoordinates = new CellCoordinates(sizeOfMatrix, sizeOfMatrix);

    private class CandidateCageCreatorParametersStub extends CandidateCageCreatorParameters {
        @Override
    ...
    private void setInvalidCellCoordinates() {
        fillArrayOfCellCoordinatesWithCoordinates(validCellCoordinates1, validCellCoordinates2, invalidCellCoordinates);
    }

    private void fillArrayOfCellCoordinatesWithCoordinates(CellCoordinates... cellCoordinates) {
        arrayOfCellCoordinates = cellCoordinates;
    }

    private void assertThatCageTypeDoesNotFitAtCellCoordinates(Matcher<Boolean> doesFitMatcher) {
        CellCoordinates originCellCoordinates = new CellCoordinates(0, 0);

        CageType cageType = mock(CageType.class);
        when(cageType.getCellCoordinatesOfAllCellsInCage(originCellCoordinates)).thenReturn(arrayOfCellCoordinates);

        assertThat(candidateCageCreator.cageTypeDoesNotFitAtCellCoordinates(cageType, originCellCoordinates),
                   doesFitMatcher);
    }

    @Test
    public void cageTypeDoesNotFitAtCellCoordinates_ListOfCellCoordinatesAreNotAllEmpty_DoesNotFit() throws Exception {
    ...
    private void setValidCellCoordinates() {
        fillArrayOfCellCoordinatesWithCoordinates(validCellCoordinates1, validCellCoordinates2);
    }
    ...
    @Test
    public void cageTypeDoesNotFitAtCellCoordinates_CageTypeFitsAtOrigin_DoesFit() throws Exception {
        setValidCellCoordinates();
    ...
    public void getCellsCoordinates() throws Exception {
        ...
        assertThat(candidateCageCreator.getCellsCoordinates(), is(sameInstance(arrayOfCellCoordinates)));
    }
    ...
    public void create() throws Exception {
        ...
        when(cageOperatorGeneratorMock.getCageOperator()).thenReturn(cageOperatorMock);

...
public class TipCopyCellValuesTest extends TipBaseTest {
    ...
    protected void initMocks() {
        super.initMocks();
        when(preferencesMock.getInputModeCopyCounter()).thenReturn(inputModeCopyCounter);
        if (gridMock != null) {
            when(gridMock.getSelectedCell()).thenReturn(selectedCellMock);
        }
        if (selectedCellMock != null) {
            when(selectedCellMock.countPossibles()).thenReturn(countPossiblesInSelectedGridCell);
        }
        if (gridMock != null && selectedCellMock != null) {
            when(gridMock.getCage(selectedCellMock)).thenReturn(selectedCageMock);
        }
        if (selectedCageMock != null) {
            when(selectedCageMock.getNumberOfCells()).thenReturn(numberOfCellsInSelectedCage);
            when(selectedCageMock.hasEmptyCells()).thenReturn(hasEmptyCellInSelectedCages);
        }
    }

    @Override
    protected void assertThatDialogToBeDisplayed(Matcher<Boolean> booleanMatcher) {
        assertThat(TipCopyCellValues.toBeDisplayed(preferencesMock, gridMock), booleanMatcher);
    }

    @Test
    public void toBeDisplayed_CopyModeHasAlreadyBeenUsed_DialogIsNotDisplayed() throws Exception {
    ...
    @Test
    public void toBeDisplayed_GridIsNull_DialogIsNotDisplayed() throws Exception {
        gridMock = null;
        initMocks();
        assertThatDialogToBeDisplayed(is(false));
    }
    ...
    @Test
    public void toBeDisplayed_SelectedCellIsNull_DialogIsNotDisplayed() throws Exception {
    ...
    @Test
    public void toBeDisplayed_TooFewPossibleValuesInSelectedCell_DialogIsNotDisplayed() throws Exception {
    ...
    @Test
    public void toBeDisplayed_SelectedCageIsNull_DialogIsNotDisplayed() throws Exception {
    ...
    @Test
    public void toBeDisplayed_TooFewCellsInSelectedCage_DialogIsNotDisplayed() throws Exception {
    ...
    @Test
    public void toBeDisplayed_CageHasNoEmptyCellsLeft_DialogIsNotDisplayed() throws Exception {

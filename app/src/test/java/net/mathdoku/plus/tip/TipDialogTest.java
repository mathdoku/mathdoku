...
public class TipDialogTest {
    ...
    @Test
    public void constructor_PreviousDialogWasNotDismissed_PreviousTipDialogIsDismissed() throws Exception {
    ...
    private void showSecondaryTipDialogWithPriority(TipDialog.TipPriority tipPriority) {
        String otherTipName = "Other Tip";
        setTipDisplayAgain(otherTipName, true);
        TipDialog nextTipDialog = new TipDialog(activity, otherTipName, tipPriority);
        assertThat(nextTipDialog.build(R.drawable.alert, "*** OTHER TIP TITLE ***", "*** OTHER TIP MESSAGE ***", null),
                   is(true));
        nextTipDialog.show();
        assertThat(ShadowAlertDialog.getLatestAlertDialog(), is((AlertDialog) nextTipDialog));
    }
    ...
    private ShadowAlertDialog showPrimaryTipDialog() {
        ...
        assertThat(ShadowAlertDialog.getLatestAlertDialog(), is((AlertDialog) primaryTipDialog));

        return shadowOf(primaryTipDialog);
    }

    private Boolean createPrimaryTipDialog() {
        primaryTipDialog = new TipDialog(activity, primaryTipName, primaryTipPriority);
        return primaryTipDialog.build(R.drawable.alert, primaryTipTitle, primaryTipMessage, primaryDrawable);
    }

    @Test
    public void build_TipShouldNotBeDisplayedAgain_TipIsNotIDisplayed() throws Exception {
    ...
    public void build_TitleIsSet() throws Exception {
        setTipDisplayAgain(primaryTipName, true);
        assertThat(showPrimaryTipDialog().getTitle()
                           .toString(), is(primaryTipTitle));
    }
    ...
    public void build_MessageIsSet() throws Exception {
        setTipDisplayAgain(primaryTipName, true);
        showPrimaryTipDialog();
        assertThat(((TextView) primaryTipDialog.findViewById(R.id.dialog_tip_text)).getText()
                           .toString(), is(primaryTipMessage));
    }
    ...
    public void build_NotHavingImage_ImageViewNotVisible() throws Exception {
        setTipDisplayAgain(primaryTipName, true);
        showPrimaryTipDialog();
        assertThat(primaryTipDialog.findViewById(R.id.dialog_tip_image)
    ...
    @Test
    public void resetDisplayedDialogs_DialogWasDisplayed_DialogIsRemoved() throws Exception {
        setTipDisplayAgain(primaryTipName, true);
        showPrimaryTipDialog();
    ...
    public void show_DotNotDisplayAgainIsEnabled_IllegalStateExceptionIsThrown() throws Exception {
        setTipDisplayAgain(primaryTipName, false);
        showPrimaryTipDialog();
    }

    @Test
    public void getDisplayTipAgain_DotNotDisplayAgainIsEnabled_TipWillNotBeDisplayedAgain() throws Exception {
        setTipDisplayAgain(primaryTipName, false);
        assertThat(primaryTipDialog.getDisplayTipAgain(preferences, primaryTipName, TipDialog.TipPriority.HIGH),
                   is(false));
    }

    @Test
    public void getDisplayTipAgain_SecondaryTipDialogHasLowerPriority_PrimaryTipDialogIsNotDismissed() throws
            Exception {
        setTipDisplayAgain(primaryTipName, true);
        showPrimaryTipDialog();
        String secondaryTipName = "** secondary tip **";
        assertThat(primaryTipDialog.getDisplayTipAgain(preferences, secondaryTipName, TipDialog.TipPriority.LOW),
                   is(false));
        assertThat(shadowOf(primaryTipDialog).hasBeenDismissed(), is(false));
    }
    ...
    private void assertThatSecondaryTipDialogIsDisplayed(boolean displaySecondaryTip) {
        ...
        do {
            ...
            displayTip = primaryTipDialog.getDisplayTipAgain(preferences, secondaryTipName, primaryTipPriority);
            maxTries--;
    ...
    @Test
    public void
    getDisplayTipAgain_SecondaryTipDialogHasSamePriorityAsFirstDialog_SecondaryTipDialogIsRandomlySelected() throws
            Exception {
    ...
    public void getPreferenceStringDisplayTipAgain() throws Exception {
        String tipName = "***NAME***";
        assertThat(TipDialog.getPreferenceStringDisplayTipAgain(tipName), is("Tip.***NAME***.DisplayAgain"));
    }

    @Test
    public void getPreferenceStringLastDisplayTime() throws Exception {
        String tipName = "***NAME***";
        assertThat(TipDialog.getPreferenceStringLastDisplayTime(tipName), is("Tip.***NAME***.LastDisplayTime"));
    }
    ...
    public void setOnClickCloseListener() throws Exception {
        setTipDisplayAgain(primaryTipName, true);
        createPrimaryTipDialog();
        primaryTipDialog.setOnClickCloseListener(new TipDialog.OnClickCloseListener() {
            @Override

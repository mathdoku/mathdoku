...
public class TipOrderOfValuesInCageTest extends TipBaseTest {
    ...
    public void setUp() {
        ...
        super.setUpTimeIntervalBetweenTwoConsecutiveDisplays("OrderOfValuesInCage",
    ...
    protected void assertThatDialogToBeDisplayed(Matcher<Boolean> booleanMatcher) {
        assertThat(TipOrderOfValuesInCage.toBeDisplayed(preferencesMock, cageMock), booleanMatcher);
    }

    @Test
    public void toBeDisplayed_CageMockIsNull_DialogIsNotDisplayed() throws Exception {
        cageMock = null;
        initMocks();
    ...
    @Test
    public void toBeDisplayed_CageOperatorNone_DialogIsNotDisplayed() throws Exception {
    ...
    @Test
    public void toBeDisplayed_CageOperatorAddIsVisible_DialogIsNotDisplayed() throws Exception {
    ...
    @Test
    public void toBeDisplayed_CageOperatorMultipleIsVisible_DialogIsNotDisplayed() throws Exception {

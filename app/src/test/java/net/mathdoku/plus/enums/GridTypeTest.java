...
public class GridTypeTest {
    ...
    public void testFromZeroBasedIndex() throws Exception {
        assertThat(GridType.fromZeroBasedIndex(0)
                           .getGridSize(), is(SMALLEST_GRID_SIZE));
    }
    ...
    public void fromGridSize_AllGridSizeFilters_CorrectlyMappedToGridSize() throws Exception {
        assertThat(GridType.GRID_2X2.getAttachedToGridTypeFilter(), is(GridTypeFilter.GRID_2X2));
        assertThat(GridType.GRID_3X3.getAttachedToGridTypeFilter(), is(GridTypeFilter.GRID_3X3));
        assertThat(GridType.GRID_4X4.getAttachedToGridTypeFilter(), is(GridTypeFilter.GRID_4X4));
        assertThat(GridType.GRID_5X5.getAttachedToGridTypeFilter(), is(GridTypeFilter.GRID_5X5));
        assertThat(GridType.GRID_6X6.getAttachedToGridTypeFilter(), is(GridTypeFilter.GRID_6X6));
        assertThat(GridType.GRID_7X7.getAttachedToGridTypeFilter(), is(GridTypeFilter.GRID_7X7));
        assertThat(GridType.GRID_8X8.getAttachedToGridTypeFilter(), is(GridTypeFilter.GRID_8X8));
        assertThat(GridType.GRID_9X9.getAttachedToGridTypeFilter(), is(GridTypeFilter.GRID_9X9));
    }

    @Test
    public void getGridSize_AllGridSizeFilters_CorrectlyMappedToGridSize() throws Exception {
        assertThat(GridType.fromGridTypeFilter(GridTypeFilter.GRID_2X2), is(GridType.GRID_2X2));
        assertThat(GridType.fromGridTypeFilter(GridTypeFilter.GRID_3X3), is(GridType.GRID_3X3));
        assertThat(GridType.fromGridTypeFilter(GridTypeFilter.GRID_4X4), is(GridType.GRID_4X4));
        assertThat(GridType.fromGridTypeFilter(GridTypeFilter.GRID_5X5), is(GridType.GRID_5X5));
        assertThat(GridType.fromGridTypeFilter(GridTypeFilter.GRID_6X6), is(GridType.GRID_6X6));
        assertThat(GridType.fromGridTypeFilter(GridTypeFilter.GRID_7X7), is(GridType.GRID_7X7));
        assertThat(GridType.fromGridTypeFilter(GridTypeFilter.GRID_8X8), is(GridType.GRID_8X8));
        assertThat(GridType.fromGridTypeFilter(GridTypeFilter.GRID_9X9), is(GridType.GRID_9X9));
    }
}
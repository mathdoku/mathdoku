...
public class GridTypeTest {
	...
	private final String[] GRID_SIZE_TEXT = { "2x2", "3x3", "4x4", "5x5",
			"6x6", "7x7", "8x8", "9x9" };

	@Test
	public void getGridSize_CheckIfAllButNoMoreGridSizesExist()
			throws Exception {
	...
	public void testFromZeroBasedIndex() throws Exception {
		assertThat(GridType.fromZeroBasedIndex(0).getGridSize(),
				is(SMALLEST_GRID_SIZE));
	}
	...
	public void testFromInteger_GridSizeTooSmall_IllegalStateExceptionThrown()
			throws Exception {
		GridType.fromInteger(SMALLEST_GRID_SIZE - 1);
	}

	@Test(expected = IllegalArgumentException.class)
	public void testFromInteger_GridSizeTooBig_IllegalStateExceptionThrown()
			throws Exception {
	...
	@Test(expected = IllegalArgumentException.class)
	public void getFromNumberOfCells_SquareOfSmallestGridSizeMinusOne()
			throws Exception {
	...
	@Test(expected = IllegalArgumentException.class)
	public void getFromNumberOfCells_SquareOfBiggestGridSizePlusOne()
			throws Exception {

...
public class GridTypeFilterTest {
	...
	public void fromGridSize_AllGridSizeFilters_CorrectlyMappedToGridSize()
			throws Exception {
		assertThat(GridTypeFilter.fromGridSize(GridType.GRID_2X2),
				is(GridTypeFilter.GRID_2X2));
		assertThat(GridTypeFilter.fromGridSize(GridType.GRID_3X3),
				is(GridTypeFilter.GRID_3X3));
		assertThat(GridTypeFilter.fromGridSize(GridType.GRID_4x4),
				is(GridTypeFilter.GRID_4X4));
		assertThat(GridTypeFilter.fromGridSize(GridType.GRID_5X5),
				is(GridTypeFilter.GRID_5X5));
		assertThat(GridTypeFilter.fromGridSize(GridType.GRID_6X6),
				is(GridTypeFilter.GRID_6X6));
		assertThat(GridTypeFilter.fromGridSize(GridType.GRID_7X7),
				is(GridTypeFilter.GRID_7X7));
		assertThat(GridTypeFilter.fromGridSize(GridType.GRID_8X8),
				is(GridTypeFilter.GRID_8X8));
		assertThat(GridTypeFilter.fromGridSize(GridType.GRID_9X9),

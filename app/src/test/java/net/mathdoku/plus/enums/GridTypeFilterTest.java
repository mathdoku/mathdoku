...
public class GridTypeFilterTest {
    GridTypeFilter[] gridTypeFilters = {GridTypeFilter.ALL, GridTypeFilter.GRID_2X2, GridTypeFilter.GRID_3X3,
    ...
    private void assertThatGridSizeFilterExists(GridTypeFilter gridTypeFilter) {
        assertThat(Arrays.asList(GridTypeFilter.values())
                           .contains(gridTypeFilter), is(true));
    }
}

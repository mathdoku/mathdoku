...
public class TickerTapeTest {
	...
	private void assertThatTickerTapeContainsItem(String item) {
		View view = tickerTape
				.findViewById(TickerTape.ID_VIEW_TICKER_TAPE_LINEAR_LAYOUT);
	...
	@Test
	public void show_TickerTapeIsNotDisabled_TickerTapeUpdatedIsStarted()
			throws Exception {
		tickerTape.show();
	...
	@Test
	public void show_TickerTapeIsDisabled_TickerTapeUpdatedIsNotStarted()
			throws Exception {
		tickerTape.disable();
		tickerTape.show();
	...
	public void cancel() throws Exception {
		...
		tickerTape.cancel();
		tickerTape.show();
		assertThat(tickerTapeUpdaterMock,
				   is(notSameInstance(initialTickerTapeUpdater)));
	}
	...
	public void isEraseConditionFulfilled_NoEraseConditionSet_False() throws Exception {
		...
		assertThat(tickerTape.isEraseConditionFulfilled(countItemsDisplayedCompletely,
														actualTimeDisplayed), is(false));
	}

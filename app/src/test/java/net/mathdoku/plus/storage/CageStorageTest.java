...
public class CageStorageTest {
    ...
    public void fromStorageString_NullLine_False() throws Exception {
        ...
        assertThat(CageStorage.getCageBuilderFromStorageString(mLine, mRevisionNumber, mCells), is(nullValue()));
    }
    ...
    @Test(expected = StorageException.class)
    public void fromStorageString_StorageStringHasTooLittleElements_False() throws Exception {
        mLine = "CAGE:2:3:4:5";
        assertThat(CageStorage.getCageBuilderFromStorageString(mLine, mRevisionNumber, mCells), is(nullValue()));
    }

    @Test(expected = StorageException.class)
    public void fromStorageString_StorageStringHasTooManyElements_False() throws Exception {
    ...
    public void fromStorageString_ValidLineWithoutCells_True() throws Exception {
        ...
        CageBuilder cageBuilder = CageStorage.getCageBuilderFromStorageString(mLine, mRevisionNumber, mCells);

        CageBuilder expectedCageBuilder = new CageBuilder().setId(1)
    ...
    @Test
    public void fromStorageString_ValidLineWithSingeCell_True() throws Exception {
        mLine = "CAGE:1:2:3:4:true";

        CageBuilder cageBuilder = CageStorage.getCageBuilderFromStorageString(mLine, mRevisionNumber,
                                                                              createCellMocksBasedOnCageIds(
    ...
    @Test
    public void fromStorageString_ValidLineWithMultipleCellCage_True() throws Exception {
    ...
    @Test
    public void toStorageString_CageWithoutCells_StorageStringCreated() throws Exception {
        ...
        assertThat(CageStorage.toStorageString(cageMock), is("CAGE:1:3:4::false"));
    }

    @Test
    public void toStorageString_CageWithSingleCell_StorageStringCreated() throws Exception {
        Cage cageMock = mock(Cage.class);
        when(cageMock.getId()).thenReturn(1);
        ...
        assertThat(CageStorage.toStorageString(cageMock), is("CAGE:1:2:3:4,:false"));
    }

    @Test
    public void toStorageString_CageWithMultipleCells_StorageStringCreated() throws Exception {
        Cage cageMock = mock(Cage.class);
        when(cageMock.getId()).thenReturn(1);
        ...
        assertThat(CageStorage.toStorageString(cageMock), is("CAGE:1:4:3:5,6,7,:false"));
    }

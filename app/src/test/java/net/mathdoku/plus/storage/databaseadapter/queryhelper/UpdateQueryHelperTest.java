...
public class UpdateQueryHelperTest {
    ...
    public void setColumnTo_TableWithSingleColumn_success() throws Exception {
        ...
        assertThat(updateQueryHelper.toString(), is("UPDATE TABLE SET `COLUMN1` = 'VALUE1'"));
    }
    ...
    public void setColumnTo_TableWithMultipleColumns_success() throws Exception {
        ...
        assertThat(updateQueryHelper.toString(), is("UPDATE TABLE SET `COLUMN1` = 'VALUE1', `COLUMN2` = 'VALUE2'"));
    }

    @Test
    public void setColumnTo_TableWithSingleColumnIsNull_success() throws Exception {
        updateQueryHelper.setColumnToValue("COLUMN1", null);
        assertThat(updateQueryHelper.toString(), is("UPDATE TABLE SET `COLUMN1` = null"));
    }

    @Test
    public void setColumnToStatement_TableWithSingleColumn_success() throws Exception {
        updateQueryHelper.setColumnToStatement("COLUMN1", "SQL-STATEMENT");
        assertThat(updateQueryHelper.toString(), is("UPDATE TABLE SET `COLUMN1` = SQL-STATEMENT"));
    }
    ...
    public void setColumnToNull_MultipleColumn_Success() throws Exception {
        ...
        assertThat(updateQueryHelper.toString(), is("UPDATE TABLE SET `COLUMN1` = null, `COLUMN2` = null"));
    }

    @Test
    public void setWhereCondition_TableWithSingleColumnIsSQL_success() throws Exception {
        ...
        assertThat(updateQueryHelper.toString(), is("UPDATE TABLE SET `COLUMN1` = 'VALUE' WHERE CONDITION"));
    }

    @Test(expected = IllegalStateException.class)
    public void toString_NoColumns_ThrowsIllegalStateException() throws Exception {

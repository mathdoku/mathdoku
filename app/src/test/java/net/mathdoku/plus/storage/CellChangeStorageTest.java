...
public class CellChangeStorageTest {
    ...
    private Cell createCellMock(int id, int enteredValue, List<Integer> possibles) {
        Cell cell = mock(Cell.class);
        when(cell.getCellId()).thenReturn(id);
        when(cell.getEnteredValue()).thenReturn(enteredValue);
        when(cell.getPossibles()).thenReturn(possibles);
    ...
    public void toStorageString_CellChangeWithEnteredValue_StorageStringCreated() {
        ...
        CellChange cellChange = new CellChange(createCellMock(cellId, enteredValue, cellPossibles));
        assertThat(mCellChangeStorage.toStorageString(cellChange), is("CELL_CHANGE:[5:2::]"));
    }
    ...
    public void toStorageString_CellChangeWithOneMaybeValue_StorageStringCreated() {
        ...
        CellChange cellChange = new CellChange(createCellMock(cellId, enteredValue, cellPossibles));
        assertThat(mCellChangeStorage.toStorageString(cellChange), is("CELL_CHANGE:[5:0:3,:]"));
    }
    ...
    public void toStorageString_CellChangeWithMultipleMaybeValue_StorageStringCreated() {
        ...
        CellChange cellChange = new CellChange(createCellMock(cellId, enteredValue, cellPossibles));
        assertThat(mCellChangeStorage.toStorageString(cellChange), is("CELL_CHANGE:[5:0:3,4,5,:]"));
    }
    ...
    public void toStorageString_CellChangeWithOneRelatedCellChange_StorageStringCreated() {
        ...
        CellChange cellChange = new CellChange(createCellMock(rootCellId, rootCellEnteredValue, rootCellPossibles));
        ...
        CellChange relatedCellChange = new CellChange(
                createCellMock(relatedCellId, relatedCellEnteredValue, relatedCellPossibles));
        cellChange.addRelatedMove(relatedCellChange);

        assertThat(mCellChangeStorage.toStorageString(cellChange), is("CELL_CHANGE:[4:1::[2:0:3,:],]"));
    }
    ...
    public void toStorageString_CellChangeWithMultipleRelatedCellChanges_StorageStringCreated() {
        ...
        CellChange relatedCellChange1 = new CellChange(
                createCellMock(relatedCellId1, relatedCellEnteredValue1, relatedCellPossibles1));
        ...
        CellChange relatedCellChange2 = new CellChange(
                createCellMock(relatedCellId2, relatedCellEnteredValue2, relatedCellPossibles2));
        cellChange.addRelatedMove(relatedCellChange2);

        assertThat(mCellChangeStorage.toStorageString(cellChange), is("CELL_CHANGE:[4:1::[2:0:3,:],[16:0:2,3,4,:],]"));
    }
}

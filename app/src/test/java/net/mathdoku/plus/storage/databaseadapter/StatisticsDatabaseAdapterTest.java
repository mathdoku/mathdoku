...
public class StatisticsDatabaseAdapterTest {
	...
	public void insert_GridStatisticsIsNull_ThrowsIllegalArgumentException()
			throws Exception {
		statisticsDatabaseAdapter.insert(null);
	}

	@Test
	public void insert_GridStatisticsIsNotNull_ThrowsIllegalArgumentException()
			throws Exception {
	...
	private GridStatistics createGridStatisticsWithAllFieldsHavingAValue(
			int id, int gridId) {
		...
		gridStatistics.mFirstMove = DatabaseUtil
				.toSQLTimestamp("2004-04-04 04:04:04.444");
		gridStatistics.mLastMove = DatabaseUtil
				.toSQLTimestamp("2005-05-05 05:05:05.555");
	...
	public void update() throws Exception {
		...
		gridStatistics.mLastMove = DatabaseUtil
				.toSQLTimestamp("2014-02-02 22:22:22.222");
	...
	public void getPrefixedColumnName() throws Exception {
		assertThat(statisticsDatabaseAdapter.getPrefixedColumnName("A123bc"),
				is("`statistics`.`A123bc`"));
	}
	...
	public void updateSolvingAttemptToBeIncludedInStatistics() throws Exception {
		...
		int idGridStatistics1 = idOfNextGridStatistics++;
		GridStatistics gridStatistics1 = createGridStatisticsWithAllFieldsHavingAValue(
				idGridStatistics1, gridId);

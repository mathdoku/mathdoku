...
public class DatabaseProjectionTest {
	...
	public void put_MapTargetStringToSourceString_TargetIsNull_ThrowsIllegalArgumentException()
			throws Exception {
		databaseProjection.put(null, SOURCE_STRING);
	}

	@Test(expected = IllegalArgumentException.class)
	public void put_MapTargetStringToSourceString_TargetIsEmpty_ThrowsIllegalArgumentException()
			throws Exception {
		databaseProjection.put("", SOURCE_STRING);
	}

	@Test(expected = IllegalArgumentException.class)
	public void put_MapTargetStringToSourceString_SourceIsNull_ThrowsIllegalArgumentException()
			throws Exception {
		databaseProjection.put(TARGET_STRING, null);
	}

	@Test(expected = IllegalArgumentException.class)
	public void put_MapTargetStringToSourceString_SourceIsEmpty_ThrowsIllegalArgumentException()
			throws Exception {
	...
	@Test(expected = IllegalArgumentException.class)
	public void put_MapTargetColumnToSourceTableColumn_TargetIsNull_ThrowsIllegalArgumentException()
			throws Exception {
		databaseProjection.put((String) null, SOURCE_TABLE, SOURCE_COLUMN);
	}

	@Test(expected = IllegalArgumentException.class)
	public void put_MapTargetColumnToSourceTableColumn_TargetIsEmpty_ThrowsIllegalArgumentException()
			throws Exception {
		databaseProjection.put("", SOURCE_TABLE, SOURCE_COLUMN);
	}

	@Test(expected = IllegalArgumentException.class)
	public void put_MapTargetColumnToSourceTableColumn_SourceTableIsNull_ThrowsIllegalArgumentException()
			throws Exception {
		databaseProjection.put(TARGET_COLUMN, null, SOURCE_COLUMN);
	}

	@Test(expected = IllegalArgumentException.class)
	public void put_MapTargetColumnToSourceTableColumn_SourceTableIsEmpty_ThrowsIllegalArgumentException()
			throws Exception {
		databaseProjection.put(TARGET_COLUMN, "", SOURCE_COLUMN);
	}

	@Test(expected = IllegalArgumentException.class)
	public void put_MapTargetColumnToSourceTableColumn_SourceColumnIsNull_ThrowsIllegalArgumentException()
			throws Exception {
		databaseProjection.put(TARGET_COLUMN, SOURCE_TABLE, null);
	}

	@Test(expected = IllegalArgumentException.class)
	public void put_MapTargetColumnToSourceTableColumn_SourceColumnIsEmpty_ThrowsIllegalArgumentException()
			throws Exception {
		databaseProjection.put(TARGET_COLUMN, SOURCE_TABLE, "");
	}

	@Test
	public void put_MapTargetColumnToSourceTableColumn_ProjectionCanBeRetrieved()
			throws Exception {
		String back_tick = "`";
		String expectedProjection = back_tick + SOURCE_TABLE + back_tick + "."
				+ back_tick + SOURCE_COLUMN + back_tick + " AS " + back_tick
				+ TARGET_COLUMN + back_tick;

		// When first adding the target_string, a null value is returned.
		assertThat(databaseProjection.put(TARGET_COLUMN, SOURCE_TABLE,
				SOURCE_COLUMN), is(nullValue()));
		assertThat(databaseProjection.size(), is(1));
		...
		// returned.
		assertThat(databaseProjection.put(TARGET_COLUMN, SOURCE_TABLE,
				SOURCE_COLUMN), is(expectedProjection));
		assertThat(databaseProjection.size(), is(1));
	}

	@Test(expected = IllegalArgumentException.class)
	public void put_MapAggregationToSourceTableColumn_TargetIsNull_ThrowsIllegalArgumentException()
			throws Exception {
		databaseProjection.put((DatabaseProjection.Aggregation) null,
				SOURCE_TABLE, SOURCE_COLUMN);
	}

	@Test(expected = IllegalArgumentException.class)
	public void put_MapAggregationToSourceTableColumn_SourceTableIsNull_ThrowsIllegalArgumentException()
			throws Exception {
		databaseProjection.put(DatabaseProjection.Aggregation.MAX, null,
				SOURCE_COLUMN);
	}

	@Test(expected = IllegalArgumentException.class)
	public void put_MapAggregationToSourceTableColumn_SourceTableIsEmpty_ThrowsIllegalArgumentException()
			throws Exception {
	...
	@Test(expected = IllegalArgumentException.class)
	public void put_MapAggregationToSourceTableColumn_SourceColumnIsNull_ThrowsIllegalArgumentException()
			throws Exception {
		databaseProjection.put(DatabaseProjection.Aggregation.MAX,
				SOURCE_TABLE, null);
	}
	...
	@Test
	public void put_MapDefaultAggregationToSourceTableColumn_ProjectionCanBeRetrieved()
			throws Exception {
		String back_tick = "`";
	...
	private void assertThatDatabaseProjectionContainsAggregation(
			DatabaseProjection.Aggregation databaseProjectAggregation,
			String expectedAggregationProjection) {
		// When first adding the target_string, a null value is returned.
		assertThat(databaseProjection.put(databaseProjectAggregation,
		...
		// returned.
		assertThat(databaseProjection.put(databaseProjectAggregation,
				SOURCE_TABLE, SOURCE_COLUMN), is(expectedAggregationProjection));
		assertThat(databaseProjection.size(), is(1));
	}

	@Test
	public void put_MapCountAggregationToSourceTableColumn_ProjectionCanBeRetrieved()
			throws Exception {
		String back_tick = "`";
	...
	@Test
	public void put_MapCountIfTrueAggregationToSourceTableColumn_ProjectionCanBeRetrieved()
			throws Exception {
		String back_tick = "`";
	...
	public void getAllColumnNames() throws Exception {
		...
		List<String> expectedColumnNames = Arrays.asList(new String[] {
				TARGET_STRING, TARGET_COLUMN, "MAX_" + SOURCE_COLUMN,
				"COUNT_" + SOURCE_COLUMN, "COUNTIF_TRUE_" + SOURCE_COLUMN });
		Collections.sort(expectedColumnNames);

		List<String> resultColumnNames = Arrays.asList(databaseProjection
				.getAllColumnNames());

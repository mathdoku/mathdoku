...
public class DatabaseForeignKeyDefinitionTest {
	...
	public void constructor_ColumnIsNull_ThrowsIllegalArgumentException()
			throws Exception {
		new DatabaseForeignKeyDefinition(null, REFERS_TO_TABLE_NAME,
				REFERS_TO_COLUMN_NAME);
	}

	@Test(expected = IllegalArgumentException.class)
	public void constructor_ColumnIsEmpty_ThrowsIllegalArgumentException()
			throws Exception {
		new DatabaseForeignKeyDefinition("", REFERS_TO_TABLE_NAME,
				REFERS_TO_COLUMN_NAME);
	}

	@Test(expected = IllegalArgumentException.class)
	public void constructor_RefersToTableIsNull_ThrowsIllegalArgumentException()
			throws Exception {
		new DatabaseForeignKeyDefinition(COLUMN_NAME, null,
				REFERS_TO_COLUMN_NAME);
	}

	@Test(expected = IllegalArgumentException.class)
	public void constructor_RefersToTableIsEmpty_ThrowsIllegalArgumentException()
			throws Exception {
		new DatabaseForeignKeyDefinition(COLUMN_NAME, "", REFERS_TO_COLUMN_NAME);
	}

	@Test(expected = IllegalArgumentException.class)
	public void constructor_RefersToColumnIsNull_ThrowsIllegalArgumentException()
			throws Exception {
	...
	@Test(expected = IllegalArgumentException.class)
	public void constructor_RefersToColumnIsEmpty_ThrowsIllegalArgumentException()
			throws Exception {
		new DatabaseForeignKeyDefinition(COLUMN_NAME, REFERS_TO_TABLE_NAME, "");
	}

...
public class CaseWhenHelperTest {
    ...
    public void addOperand_SingleWhenThen_success() throws Exception {
        caseWhenHelper.addOperand(getFieldOperatorValueMock("CONDITION"), "VALUE");
    ...
    public void addOperand_MultipleWhenThen_success() throws Exception {
        caseWhenHelper.addOperand(getFieldOperatorValueMock("CONDITION1"), "VALUE1");
        caseWhenHelper.addOperand(getFieldOperatorValueMock("CONDITION2"), "VALUE2");

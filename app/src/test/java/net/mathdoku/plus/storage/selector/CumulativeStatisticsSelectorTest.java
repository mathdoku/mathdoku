...
public class CumulativeStatisticsSelectorTest {
    ...
    public void setUp() throws Exception {
        if (!setupAtFirstTestIsExecuted) {
			 ...
			 */
            TestRunnerHelper.setup(CumulativeStatisticsSelectorTest.class.getCanonicalName());
            String pathToImportFile = "net/mathdoku/plus/storage/databaseadapter/selector/";
            new DatabaseCsvImporter(pathToImportFile + "CumulativeStatisticsSelectorTest_grid.csv",
                                    new GridDatabaseAdapter()).importFile();
            new DatabaseCsvImporter(pathToImportFile + "CumulativeStatisticsSelectorTest_statistics.csv",
    ...
    public void invoke_GetAllGridsWithSize4() throws Exception {
        int minGridSize = 4;
        int maxGridSize = 4;
        CumulativeStatistics cumulativeStatistics = new CumulativeStatisticsSelector(minGridSize,
                                                                                     maxGridSize)
                .getCumulativeStatistics();

        assertThat(cumulativeStatistics, is(notNullValue()));
        assertThat("Minimum grid size", cumulativeStatistics.mMinGridSize, is(minGridSize));
        assertThat("Maximum grid size", cumulativeStatistics.mMaxGridSize, is(maxGridSize));
        assertThat("Grids started", cumulativeStatistics.mCountStarted, is(2));
        assertThat("Grids revealed", cumulativeStatistics.mCountSolutionRevealed, is(0));
        assertThat("Grids solved manually", cumulativeStatistics.mCountSolvedManually, is(1));
    ...
    public void invoke_GetAllGridsWithSize5() throws Exception {
        ...
        assertThat("Grids revealed", cumulativeStatistics.mCountSolutionRevealed, is(1));
        assertThat("Grids solved manually", cumulativeStatistics.mCountSolvedManually, is(2));
    ...
    public void invoke_GetAllGridsWithSize4Or5() throws Exception {
        ...
        assertThat("Grids revealed", cumulativeStatistics.mCountSolutionRevealed, is(1));
        assertThat("Grids solved manually", cumulativeStatistics.mCountSolvedManually, is(3));

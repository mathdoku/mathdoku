...
public class DatabaseHelperTest {
    ...
    @Test
    public void getInstance_InstantiateWithContext_Instantiated() throws Exception {
    ...
    @Test
    public void getInstance_InstantiateTwiceWithDifferentContext_SameInstance() throws Exception {
        initTestRunnerHelper();
        assertThat(DatabaseHelper.getInstance(new Activity()), is(sameInstance(databaseHelper)));
    }

    @Test
    public void getInstance_InstantiateTwiceWithSameContext_SameInstance() throws Exception {
        initTestRunnerHelper();
        assertThat(DatabaseHelper.getInstance(activity), is(sameInstance(databaseHelper)));
    }

    public void getInstance_NotInstantiatedBefore_ThrowsSingletonInstanceNotInstantiatedException() throws Exception {
        databaseHelper = DatabaseHelper.getInstance();
    }

    public void getInstance_InstantiatedBefore_SameInstance() throws Exception {
        initTestRunnerHelper();
        assertThat(DatabaseHelper.getInstance(), is(sameInstance(databaseHelper)));
    }

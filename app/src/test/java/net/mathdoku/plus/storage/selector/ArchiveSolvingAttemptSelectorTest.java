...
public class ArchiveSolvingAttemptSelectorTest {
    ...
    private static List<ArchiveSolvingAttemptSelector.LatestSolvingAttemptForGrid>
    ...
    public void setup() {
        ...
        latestSolvingAttemptForAllSolvedGrids = new ArrayList<ArchiveSolvingAttemptSelector
                .LatestSolvingAttemptForGrid>();
        latestSolvingAttemptForAllGridsWithSize4 = new ArrayList<ArchiveSolvingAttemptSelector
                .LatestSolvingAttemptForGrid>();
        latestSolvingAttemptForAllSolvedGridsWithSize4 = new ArrayList<ArchiveSolvingAttemptSelector
                .LatestSolvingAttemptForGrid>();
    ...
    private Grid createAndSaveGrid(Grid grid) {
        ...
        latestSolvingAttemptForGrid = new ArchiveSolvingAttemptSelector.LatestSolvingAttemptForGrid(grid.getRowId(),
        ...
        if (grid.isSolved()) {
            latestSolvingAttemptForAllSolvedGrids.add(latestSolvingAttemptForGrid);
        }
        if (grid.getGridSize() == 4) {
            latestSolvingAttemptForAllGridsWithSize4.add(latestSolvingAttemptForGrid);
        }
        if (grid.isSolved() && grid.getGridSize() == 4) {
            latestSolvingAttemptForAllSolvedGridsWithSize4.add(latestSolvingAttemptForGrid);
        }
    ...
    public void getLatestSolvingAttemptIdPerGrid_AllGrids() throws Exception {
        assertThatLatestSolvingAttemptIdPerGrid(StatusFilter.ALL, GridTypeFilter.ALL,
                                                is(latestSolvingAttemptForAllGrids));
    }

    private void assertThatLatestSolvingAttemptIdPerGrid(StatusFilter statusFilter, GridTypeFilter gridTypeFilter,
                                                         Matcher<List<ArchiveSolvingAttemptSelector
                                                                 .LatestSolvingAttemptForGrid>>
                                                                 expectedLatestSolvingAttemptForGrids) {
        List<ArchiveSolvingAttemptSelector.LatestSolvingAttemptForGrid> resultLatestSolvingAttemptForGrids =
                getResultLatestSolvingAttemptForGrids(
                statusFilter, gridTypeFilter);
        assertThat(resultLatestSolvingAttemptForGrids, is(expectedLatestSolvingAttemptForGrids));
    }
    ...
    private List<ArchiveSolvingAttemptSelector.LatestSolvingAttemptForGrid> getResultLatestSolvingAttemptForGrids
        ...
        return new ArchiveSolvingAttemptSelector(statusFilter, gridTypeFilter).getLatestSolvingAttemptIdPerGrid();
    }

    @Test
    public void getLatestSolvingAttemptIdPerGrid_AllSolvedGrids() throws Exception {
        assertThatLatestSolvingAttemptIdPerGrid(StatusFilter.SOLVED, GridTypeFilter.ALL,
                                                is(latestSolvingAttemptForAllSolvedGrids));
    }

    @Test
    public void getLatestSolvingAttemptIdPerGrid_AllGridsWithSize4() throws Exception {
        assertThatLatestSolvingAttemptIdPerGrid(StatusFilter.ALL, GridTypeFilter.GRID_4X4,
                                                is(latestSolvingAttemptForAllGridsWithSize4));
    }

    @Test
    public void getLatestSolvingAttemptIdPerGrid_AllSolvedGridsWithSize4() throws Exception {
        assertThatLatestSolvingAttemptIdPerGrid(StatusFilter.SOLVED, GridTypeFilter.GRID_4X4,
    ...
    public void countGrids_AllGrids() throws Exception {
        ...
        assertThat(resultLatestSolvingAttemptForGrids.size(), is(latestSolvingAttemptForAllGrids.size()));
    }
}

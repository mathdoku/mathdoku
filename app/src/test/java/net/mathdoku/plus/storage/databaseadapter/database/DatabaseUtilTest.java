...
public class DatabaseUtilTest {
    ...
    public void stringBetweenBackTicks() throws Exception {
        assertThat(DatabaseUtil.stringBetweenBackTicks("STRING"), is("`STRING`"));
    }
    ...
    public void valueOfSQLiteBoolean_True_ThrowsIllegalStateException() throws Exception {
    ...
    public void getCurrentSQLiteTimestamp() throws Exception {
        ...
        assertThat(new DatabaseUtil(calendar.getTimeInMillis()).getCurrentSQLiteTimestamp(),
    ...
    public void getCurrentMinusOffsetSQLiteTimestamp() throws Exception {
        ...
        // Instantiate DatabaseUtil to feed it with a specific time which will
        // be returned as current time.
        assertThat(new DatabaseUtil(calendar.getTimeInMillis()).getCurrentMinusOffsetSQLiteTimestamp(
                           offsetToLastMillisecondOnPreviousDay), is("2014-04-30 23:59:59.999"));
    }

    @Test
    public void toSQLiteTimestamp() throws Exception {
        assertThat(DatabaseUtil.toSQLiteTimestamp(1399042037851L), is("2014-05-02 16:47:17.851"));
    }

    @Test
    public void toSQLTimestamp_TimeIsNotNull() throws Exception {
        assertThat(DatabaseUtil.toSQLTimestamp("2014-05-02 16:47:17.851")
                           .getTime(), is(1399042037851L));
    }

    @Test
    public void toSQLTimestamp_TimeIsNull() throws Exception {
        assertThat(DatabaseUtil.toSQLTimestamp(null)
                           .getTime(), is(0L));
    }

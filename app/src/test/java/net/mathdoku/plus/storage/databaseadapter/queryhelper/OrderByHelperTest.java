...
public class OrderByHelperTest {
	...
	public void sortAscending_3ColumnsSet_Success() throws Exception {
		...
		assertThat(orderByHelper.toString(),
				is("`COLUMN1` ASC, `COLUMN2` ASC, `COLUMN3` ASC"));
	}
	...
	public void sortDescending_3ColumnsSet_Success() throws Exception {
		...
		assertThat(orderByHelper.toString(),
				is("`COLUMN1` DESC, `COLUMN2` DESC, `COLUMN3` DESC"));
	}

	@Test(expected = IllegalStateException.class)
	public void toString_NoColumnsSet_ThrowsIllegalStateException()
			throws Exception {
		orderByHelper.toString();
	}

	@Test
	public void toString_3ColumnsSet_ThrowsIllegalStateException()
			throws Exception {
		orderByHelper.sortDescending("COLUMN1");
		orderByHelper.sortAscending("COLUMN2");
		orderByHelper.sortDescending("COLUMN3");
		assertThat(orderByHelper.toString(),
				is("`COLUMN1` DESC, `COLUMN2` ASC, `COLUMN3` DESC"));
	}
}

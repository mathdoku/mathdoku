...
public class DatabaseColumnDropperTest {
    ...
    private class TestTableDatabaseAdapter extends DatabaseAdapter {
        ...
        public DatabaseTableDefinition getDatabaseTableDefinition() {
            DatabaseTableDefinition databaseTableDefinition = new DatabaseTableDefinition("TestTable");
            databaseTableDefinition.addColumn(new DatabaseColumnDefinition(KEY_TO_BE_KEPT_1, DataType.STRING));
            databaseTableDefinition.addColumn(new DatabaseColumnDefinition(KEY_TO_BE_KEPT_2, DataType.STRING));
            databaseTableDefinition.addColumn(new DatabaseColumnDefinition(KEY_TO_BE_DELETED_1, DataType.STRING));
            databaseTableDefinition.addColumn(new DatabaseColumnDefinition(KEY_TO_BE_KEPT_3, DataType.STRING));
            databaseTableDefinition.addColumn(new DatabaseColumnDefinition(KEY_TO_BE_DELETED_2, DataType.STRING));
    ...
    @Test(expected = IllegalArgumentException.class)
    public void dropColumns_EmptyColumn_ThrowsDatabaseException() throws Exception {
        assertThat(databaseColumnDropper.dropColumns(new String[]{""}), is(false));
    }
    ...
    public void dropColumns_DropTwoExistingColumns_Success() throws Exception {
        assertThat(databaseColumnDropper.dropColumns(new String[]{KEY_TO_BE_DELETED_1, KEY_TO_BE_DELETED_2}), is(true));
    }
    ...
    public void dropColumns_DropAllColumns_ThrowsDatabaseException() throws Exception {
        assertThat(databaseColumnDropper.dropColumns(
                           new String[]{KEY_TO_BE_KEPT_1, KEY_TO_BE_KEPT_2, KEY_TO_BE_DELETED_1, KEY_TO_BE_KEPT_3,

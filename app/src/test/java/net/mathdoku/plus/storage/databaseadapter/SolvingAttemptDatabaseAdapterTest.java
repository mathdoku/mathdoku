...
public class SolvingAttemptDatabaseAdapterTest {
    ...
    private static class SolvingAttemptRowStub extends SolvingAttemptRow {
        ...
        private SolvingAttemptRowStub(int solvingAttemptId, int gridId, long solvingAttemptDateCreated,
                                      long solvingAttemptDateUpdated, SolvingAttemptStatus solvingAttemptStatus,
                                      int savedWithRevision, String storageString) {
            super(solvingAttemptId, gridId, solvingAttemptDateCreated, solvingAttemptDateUpdated, solvingAttemptStatus,
                  savedWithRevision, storageString);
        }

        public SolvingAttemptRowStub(String storageString) {
            super(solvingAttemptIdWhichIsIgnoredDuringInsert, gridId, dateCreated, dateUpdated,
                  SolvingAttemptStatus.UNFINISHED, revision, storageString);
        ...
        public static SolvingAttemptRowStub createUpdatedSolvingAttemptRowStub(SolvingAttemptRow source) {
            systemCurrentTimeInMillis++;
            return new SolvingAttemptRowStub(source.getSolvingAttemptId(), source.getGridId(),
                                             source.getSolvingAttemptDateCreated(), systemCurrentTimeInMillis,
                                             source.getSolvingAttemptStatus(), source.getSavedWithRevision(),
                                             source.getStorageString());
        }
    }
    ...
    public void insert_SolvingAttemptRowIsNotNull() throws Exception {
        ...
        assertThat(solvingAttemptRow.getSolvingAttemptId(), is(idOfFirstSolvingAttemptIdInEmptyDatabase));
    }

    private SolvingAttemptRow createAndInsertSolvingAttemptRow(String storageString) {
        return solvingAttemptDatabaseAdapter.insert(new SolvingAttemptRowStub(storageString));
    }
    ...
    public void getSolvingAttemptRow() throws Exception {
        ...
        assertThat(solvingAttemptDatabaseAdapter.getSolvingAttemptRow(solvingAttemptId), is(solvingAttemptRow));
    }

    @Test
    public void getMostRecentPlayedId_WhenInsertWasLastSaveAction() throws Exception {
        createAndInsertSolvingAttemptRow("*** SOME STORAGE STRING 1 ***");
        SolvingAttemptRow lastSolvingAttemptRowInserted = createAndInsertSolvingAttemptRow(
                "*** SOME STORAGE STRING 2 ***");
    ...
    @Test
    public void getMostRecentPlayedId_WhenUpdateWasLastSaveAction() throws Exception {
        ...
        solvingAttemptDatabaseAdapter.update(
                SolvingAttemptRowStub.createUpdatedSolvingAttemptRowStub(solvingAttemptRow1));

        assertThat(solvingAttemptDatabaseAdapter.getMostRecentPlayedId(), is(solvingAttemptRow1.getSolvingAttemptId()));
    }
    ...
    public void updateSolvingAttemptRowIsNotNull() throws Exception {
        SolvingAttemptRow solvingAttemptRow = createAndInsertSolvingAttemptRow("*** SOME STORAGE STRING 1 ***");
        SolvingAttemptRow updatedSolvingAttemptRow = SolvingAttemptRowStub.createUpdatedSolvingAttemptRowStub(
                solvingAttemptRow);
        assertThat(solvingAttemptDatabaseAdapter.update(updatedSolvingAttemptRow), is(true));
        assertThat(solvingAttemptDatabaseAdapter.getSolvingAttemptRow(solvingAttemptRow.getSolvingAttemptId()),
                   is(updatedSolvingAttemptRow));
    }
    ...
    public void getAllToBeConverted() throws Exception {
        ...
        List<Integer> resultGridIds = solvingAttemptDatabaseAdapter.getAllToBeConverted();
        Collections.sort(resultGridIds);

        List<Integer> expectedGridIds = new ArrayList<Integer>();
        for (Map.Entry<Integer, Integer> entry : insertedSolvingAttempts.entrySet()) {
    ...
    private void createSolvingAttemptsForMultipleGrids(int gridId1, int gridId2) {
        createAndInsertSolvingAttemptRowAndSaveCreatedIds(gridId1, "*** SOME STORAGE STRING 1 FOR GRID 1 ***");
        createAndInsertSolvingAttemptRowAndSaveCreatedIds(gridId2, "*** SOME STORAGE STRING 2 FOR GRID 2 ***");
        createAndInsertSolvingAttemptRowAndSaveCreatedIds(gridId1, "*** SOME STORAGE STRING 3 FOR GRID 1 ***");
    }

    @Test(expected = IllegalArgumentException.class)
    public void getPrefixedColumnName_ColumnNameIsNull_ThrowsIllegalArgumentException() throws Exception {
        assertThat(SolvingAttemptDatabaseAdapter.getPrefixedColumnName(null), is("`solving_attempt`.`TestAbC`"));
    }

    @Test(expected = IllegalArgumentException.class)
    public void getPrefixedColumnName_ColumnNamIsEmpty_ThrowsIllegalArgumentException() throws Exception {
        assertThat(SolvingAttemptDatabaseAdapter.getPrefixedColumnName(""), is("`solving_attempt`.`TestAbC`"));
    }

    @Test
    public void getPrefixedColumnName_ColumnNameIsNotNull() throws Exception {
        assertThat(SolvingAttemptDatabaseAdapter.getPrefixedColumnName("TestAbC"), is("`solving_attempt`.`TestAbC`"));
    }
    ...
    public void countSolvingAttemptForGrid() throws Exception {
        ...
        assertThat(solvingAttemptDatabaseAdapter.countSolvingAttemptForGrid(gridId1), is(expectedCountGridId1));
    }

    private SolvingAttemptRow createAndInsertSolvingAttemptRowAndSaveCreatedIds(int gridId, String storageString) {
        SolvingAttemptRow solvingAttemptRow = solvingAttemptDatabaseAdapter.insert(
                new SolvingAttemptRowStub(gridId, storageString));

        if (insertedSolvingAttempts == null) {
            insertedSolvingAttempts = new HashMap<Integer, Integer>();
        }
        insertedSolvingAttempts.put(solvingAttemptRow.getSolvingAttemptId(), solvingAttemptRow.getGridId());

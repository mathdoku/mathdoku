...
public class DatabaseColumnDefinitionTest {
    ...
    @Before
    public void setup() {
        databaseColumnDefinition = new DatabaseColumnDefinition(COLUMN_NAME, COLUMN_DATA_TYPE);
        ...
        expectedColumnDefinitionStringBuilder.append("` ");
        expectedColumnDefinitionStringBuilder.append(COLUMN_DATA_TYPE.getSqliteDataType());
    }

    @Test(expected = IllegalArgumentException.class)
    public void constructor_ColumnNameIsNull_ThrowsIllegalArgumentException() throws Exception {
        databaseColumnDefinition = new DatabaseColumnDefinition(null, DataType.STRING);
    }

    @Test(expected = IllegalArgumentException.class)
    public void constructor_ColumnNameIsEmpty_ThrowsIllegalArgumentException() throws Exception {
        databaseColumnDefinition = new DatabaseColumnDefinition("", DataType.STRING);
    }

    @Test(expected = IllegalArgumentException.class)
    public void constructor_DataTypeIsNull_ThrowsIllegalArgumentException() throws Exception {
        databaseColumnDefinition = new DatabaseColumnDefinition(COLUMN_NAME, null);
    }

    @Test
    public void getColumnClause_SimpleColumn_Success() throws Exception {
        assertThatDatabaseColumnDefinitionMatches(expectedColumnDefinitionStringBuilder.toString());
    }

    private void assertThatDatabaseColumnDefinitionMatches(String expectedColumnDefinition) {
        assertThat(databaseColumnDefinition.getColumnClause(), is(expectedColumnDefinition));
    }

    @Test
    public void getColumnClause_ColumnWithPrimaryKey_Success() throws Exception {
        databaseColumnDefinition.setPrimaryKey();
        expectedColumnDefinitionStringBuilder.append(" primary key autoincrement");
        assertThatDatabaseColumnDefinitionMatches(expectedColumnDefinitionStringBuilder.toString());
    }
    ...
    @Test
    public void getColumnClause_ColumnWithDefaultStringValue_Success() throws Exception {
    ...
    @Test
    public void getColumnClause_ColumnWithDefaultEmptyStringValue_Success() throws Exception {
    ...
    @Test
    public void getColumnClause_ColumnWithDefaultBooleanValue_Success() throws Exception {
    ...
    @Test
    public void getColumnClause_ColumnWithDefaultIntegerValue_Success() throws Exception {
    ...
    public void getColumnClause_ColumnNotNullWithDefaultValueUniqueKeyAndPrimaryKeyDefaultIntegerValue_Success()
        ...
        databaseColumnDefinition.setUniqueKey();
        databaseColumnDefinition.setPrimaryKey();
        expectedColumnDefinitionStringBuilder.append(" primary key autoincrement not null unique default 67283");
        assertThatDatabaseColumnDefinitionMatches(expectedColumnDefinitionStringBuilder.toString());
    }

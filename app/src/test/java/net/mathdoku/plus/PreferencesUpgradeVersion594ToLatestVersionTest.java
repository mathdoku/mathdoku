...
public class PreferencesUpgradeVersion594ToLatestVersionTest extends PreferencesUpgradeVersion595ToLatestVersionTest {
    private int APP_VERSION = 594;

    @Before
    public void setUp() throws Exception {
        super.setUp(this.getClass()
                            .getCanonicalName(), APP_VERSION, "user_preferences_version_594.csv");
    }

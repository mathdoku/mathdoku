...
public class GridTest {
    ...
    /**
     * The GridBuilderStub is used set up a default grid builder for each test case. It has some additional methods for
     * tweaking the setup for specific test cases.
     */
    private class GridBuilderStub extends GridBuilder {
        ...
        public GridBuilderStub setupDefaultWhichDoesNotThrowErrorsOnBuild() {
            ...
            mGridGeneratingParametersDefaultSetup = mGridObjectsCreator.createGridGeneratingParameters(gridType,
                                                                                                       mHideOperators,
                                                                                                       PuzzleComplexity.EASY,
                                                                                                       598);
            super.setGridGeneratingParameters(mGridGeneratingParametersDefaultSetup);

            return this;
        }

        /**
         * Initializes the list of cells of the GridBuilder with the given grid cells.
         */
        ...
        /**
         * Initializes the list of cages of the GridBuilder with the given grid cages.
         */
        ...
        /**
         * Initializes the list of cell changess of the GridBuilder with the given cell changes.
         */
        public GridBuilderStub setCellChangesInitializedWith(CellChange... cellChange) {
        ...
        public GridBuilderStub setCellMockAsSelectedCell(int idSelectedCell) {
            ...
            when(mCellMockOfDefaultSetup[idSelectedCell].isSelected()).thenReturn(true);

            return this;
        }

        private GridBuilderStub setCellMockWithEnteredValue(int id, int row, int column, int enteredValue) {
            ...
            // Set user value
            when(mCellMockOfDefaultSetup[id].getEnteredValue()).thenReturn(enteredValue);

            return this;
        }

        private GridBuilderStub setCellMockWithMaybeValues(int id, int row, int column, int maybeValues[]) {
            when(mCellMockOfDefaultSetup[id].getRow()).thenReturn(row);
            when(mCellMockOfDefaultSetup[id].getColumn()).thenReturn(column);
            for (int maybeValue : maybeValues) {
                when(mCellMockOfDefaultSetup[id].hasPossible(maybeValue)).thenReturn(true);
            }
    ...
    public void setUp() {
        ...
        mPreferencesMock = Preferences.getInstance(mActivity, preferencesObjectsCreator);
    ...
    public void getSelectedCage_SelectedCellIsNotNull_CageSelected() {
        ...
        assertThat("Selected cage", grid.getSelectedCage(), is(grid.getCage(idSelectedCage)));
    }

    @Test
    public void clearCells_GridWithMultipleMovesCleared_AllMovesCleared() throws Exception {
        mGridBuilderStub.setCellChangesInitializedWith(mCellChangeMock, mock(CellChange.class), mock(CellChange.class),
                                                       mock(CellChange.class));
        Grid grid = mGridBuilderStub.build();
        assertThat("Number of cell changes before clear", grid.countMoves(), is(mGridBuilderStub.mCellChanges.size()));

        grid.clearCells();

        assertThat("Number of moves for grid after clear", grid.countMoves(), is(0));
    }

    @Test
    public void clearCells_GridWithMultipleCellsCleared_AllCellsCleared() throws Exception {
        Grid grid = mGridBuilderStub.useSameMockForAllCells()
        ...
        verify(mGridBuilderStub.mAnyCellMockOfDefaultSetup, times(grid.getCells()
                                                                          .size())).clearValue();
    }
    ...
    @Test
    public void clearCells_AnyGrid_UserMathOfAllCagesIsChecked() throws Exception {
        Grid grid = mGridBuilderStub.build();
        ...
        verify(mGridBuilderStub.mAnyCageOfDefaultSetup, times(2)).checkMathOnEnteredValues();
    }
    ...
    private void assertThatCellDoesNotExist(int gridSize, int row, int col) {
        ...
        assertThat("Cell found for row and column", grid.getCellAt(row, col), is(nullValue()));
    }
    ...
    @Test
    public void getCellAt_RowNumberGreaterOrEqualsToGridSize_CellDoesNotExist() throws Exception {
        int gridSize = 4;
        int row = gridSize;
        int col = 1;
    ...
    @Test
    public void getCellAt_ColNumberGreaterOrEqualsToGridSize_CellDoesNotExist() throws Exception {
        int gridSize = 4;
        int row = 1;
        int col = gridSize;
    ...
    public void getCellAt_ValidRowAndColNumber_NotNull() throws Exception {
        ...
        assertThat("Cell retrieved from grid",
                   grid.getCellAt(mGridBuilderStub.mGridSize - 1, mGridBuilderStub.mGridSize - 1),
                   is(sameInstance(mGridBuilderStub.mAnyCellMockOfDefaultSetup)));
    }

    @Test
    public void revealSolution_NonEmptyCellListWith2IncorrectCells_TwoCellsRevealed() throws Exception {
        mGridBuilderStub.useSameMockForAllCells()
                .setupDefaultWhichDoesNotThrowErrorsOnBuild();
        when(mGridBuilderStub.mAnyCellMockOfDefaultSetup.isEnteredValueIncorrect()).thenReturn(false, true, false, true,
                                                                                               false);
        Grid grid = mGridBuilderStub.build();
        ...
        // false
        verify(mGridBuilderStub.mAnyCellMockOfDefaultSetup, times(expectedNumberOfCellsRevealed)).revealCorrectValue();
    }

    @Test
    public void revealSolution_GridWithHiddenOperators_OperatorsRevealed() throws Exception {
        mGridBuilderStub.useSameMockForAllCells()
        ...
        verify(mGridBuilderStub.mAnyCageOfDefaultSetup, times(mGridBuilderStub.mCages.size())).revealOperator();
        // Check if setCageText is called a second time for each cage
        verify(mGridBuilderStub.mAnyCellMockOfDefaultSetup, times(2 * mGridBuilderStub.mCages.size())).setCageText(
                anyString());

    }

    @Test
    public void revealSolution_NonEmptyCellList_GridStatisticsUpdated() throws Exception {
        Grid grid = mGridBuilderStub.build();
        grid.revealSolution();
    ...
    public void isSolved_UnSolvedGridIsChecked_False() throws Exception {
        mGridBuilderStub.useSameMockForAllCells()
                .setupDefaultWhichDoesNotThrowErrorsOnBuild();
        when(mGridBuilderStub.mAnyCellMockOfDefaultSetup.isEnteredValueIncorrect()).thenReturn(false, false, true,
                                                                                               false);
        Grid grid = mGridBuilderStub.build();
        ...
        // Check if test isn't flawed with incorrect number of cells in list.
        verify(mGridBuilderStub.mAnyCellMockOfDefaultSetup, atLeast(1)).isEnteredValueIncorrect();
    }
    ...
    public void isSolved_SolvedGridIsChecked_True() throws Exception {
        mGridBuilderStub.useSameMockForAllCells()
                .setupDefaultWhichDoesNotThrowErrorsOnBuild();
        when(mGridBuilderStub.mAnyCellMockOfDefaultSetup.isEnteredValueIncorrect()).thenReturn(false);
        Grid grid = mGridBuilderStub.build();
    ...
    public void isSolutionValidSoFar_AllCellsEmpty_True() throws Exception {
        mGridBuilderStub.useSameMockForAllCells()
                .setupDefaultWhichDoesNotThrowErrorsOnBuild();
        when(mGridBuilderStub.mAnyCellMockOfDefaultSetup.hasEnteredValue()).thenReturn(false);
        Grid grid = mGridBuilderStub.build();

        assertThat("Grid is valid so far", grid.isSolutionValidSoFar(), is(true));
    }

    @Test
    public void isSolutionValidSoFar_FilledCellIsValid_True() throws Exception {
        when(mGridBuilderStub.mAnyCellMockOfDefaultSetup.hasEnteredValue()).thenReturn(true);
        when(mGridBuilderStub.mAnyCellMockOfDefaultSetup.getEnteredValue()).thenReturn(2);
        when(mGridBuilderStub.mAnyCellMockOfDefaultSetup.isEnteredValueIncorrect()).thenReturn(false);
        Grid grid = mGridBuilderStub.build();
    ...
    @Test
    public void isSolutionValidSoFar_FilledCellIsInvalid_False() throws Exception {
        when(mGridBuilderStub.mAnyCellMockOfDefaultSetup.hasEnteredValue()).thenReturn(true);
        when(mGridBuilderStub.mAnyCellMockOfDefaultSetup.getEnteredValue()).thenReturn(2);
        when(mGridBuilderStub.mAnyCellMockOfDefaultSetup.isEnteredValueIncorrect()).thenReturn(true);
        Grid grid = mGridBuilderStub.build();

        assertThat("Grid is valid so far", grid.isSolutionValidSoFar(), is(false));
    }

    @Test
    public void isSolutionValidSoFar_MultipleCellsIncludingAnInvalid_False() throws Exception {
        int cellIdToBeFilledWithCorrectValue = 4;
        Grid grid = GridCreator4x4.createEmpty()
                .setCorrectEnteredValueInCell(cellIdToBeFilledWithCorrectValue)
                .setCorrectEnteredValueInCell(cellIdToBeFilledWithCorrectValue + 1)
                .setIncorrectEnteredValueInCell(cellIdToBeFilledWithCorrectValue + 2)
                .getGrid();
    ...
    public void addMove_FirstMoveAddedToNullList_True() throws Exception {
        ...
        assertThat("Number of cell changes", mGridTestObjectsCreator.mArrayListOfCellChanges.size(), is(1));
    }
    ...
    public void addMove_AddMultipleDifferentMoves_True() throws Exception {
        ...
        assertThat("Number of cell changes", mGridTestObjectsCreator.mArrayListOfCellChanges.size(), is(2));
    }
    ...
    public void countMoves_MovesListIsNull_ZeroMoves() throws Exception {
        ...
        assertThat("Number of moves in a Grid with an null moves list", actualNumberOfCellChanges, is(0));
    }

    @Test
    public void countMoves_MovesListIsNotEmpty_MovesCountedCorrectly() throws Exception {
        mGridBuilderStub.setCellChangesInitializedWith(mock(CellChange.class), mock(CellChange.class),
                                                       mock(CellChange.class), mock(CellChange.class),
                                                       mock(CellChange.class), mock(CellChange.class));
        Grid grid = mGridBuilderStub.build();

        assertThat("Number of moves in a Grid with a non-empty moves list", grid.countMoves(),
    ...
    public void countMoves_MovesListIsEmpty_ZeroMoves() throws Exception {
        Grid grid = mGridBuilderStub.build();
        int actualNumberOfCellChanges = grid.countMoves();
        assertThat("Number of moves in a Grid with an empty moves list", actualNumberOfCellChanges, is(0));
    }
    ...
    @Test
    public void deselectSelectedCell_CellIsSelected_CellIsDeselected() throws Exception {
    ...
    public void setSelectedCell_SelectNullCell_Null() throws Exception {
        Grid grid = mGridBuilderStub.build();
        assertThat("Selected cell", grid.setSelectedCell((Cell) null), is(nullValue()));
    }

    @Test
    public void setSelectedCell_NoCellCurrentlySelectedInGrid_BordersOfNewCageSetAndSelectedCellReturned() throws
            Exception {
        int cageIdOfSelectedCell = 1;
        when(mGridBuilderStub.mAnyCellMockOfDefaultSetup.getCageId()).thenReturn(cageIdOfSelectedCell);
        Grid grid = mGridBuilderStub.build();

        assertThat("Selected cell", grid.setSelectedCell(mGridBuilderStub.mAnyCellMockOfDefaultSetup),
                   is(sameInstance(mGridBuilderStub.mAnyCellMockOfDefaultSetup)));

        verify(mGridBuilderStub.mCageMockOfDefaultSetup[cageIdOfSelectedCell]).invalidateBordersOfAllCells();
    }

    @Test
    public void setSelectedCell_SelectAnotherCellInTheCurrentlySelectedCage_OldSelectedCellIsDeselected() throws
            Exception {
    ...
    @Test
    public void setSelectedCell_CurrentlySelectedCellInGridIsSelectedAgain_NoBordersReset() throws Exception {
        int cageIdOfSelectedCell = 1;
        when(mGridBuilderStub.mAnyCellMockOfDefaultSetup.getCageId()).thenReturn(cageIdOfSelectedCell);
        Grid grid = mGridBuilderStub.build();
        ...
        grid.setSelectedCell(mGridBuilderStub.mAnyCellMockOfDefaultSetup);
        verify(mGridBuilderStub.mCageMockOfDefaultSetup[cageIdOfSelectedCell], times(1)).invalidateBordersOfAllCells();
    ...
    @Test
    public void setSelectedCell_SelectAnotherCellInTheCurrentlySelectedCage_NoBordersReset() throws Exception {
        Grid grid = mGridBuilderStub.build();

        int cellId1 = 3;
        int cellId2 = 4;
        int selectedCageId = 1;
        when(mGridBuilderStub.mCellMockOfDefaultSetup[cellId1].getCageId()).thenReturn(selectedCageId);
        when(mGridBuilderStub.mCellMockOfDefaultSetup[cellId2].getCageId()).thenReturn(selectedCageId);

        // Select grid cell stub 1
        grid.setSelectedCell(mGridBuilderStub.mCellMockOfDefaultSetup[cellId1]);
        verify(mGridBuilderStub.mCageMockOfDefaultSetup[selectedCageId], times(1)).invalidateBordersOfAllCells();
    ...
    @Test
    public void setSelectedCell_SelectCellInAnotherCage_NoBordersReset() throws Exception {
        Grid grid = mGridBuilderStub.build();

        int cellId1 = 3;
        int cageId1 = 0;
        when(mGridBuilderStub.mCellMockOfDefaultSetup[cellId1].getCageId()).thenReturn(cageId1);

        int cellId2 = 4;
        int cageId2 = 1;
        when(mGridBuilderStub.mCellMockOfDefaultSetup[cellId2].getCageId()).thenReturn(cageId2);

        // Select grid cell stub 1
        grid.setSelectedCell(mGridBuilderStub.mCellMockOfDefaultSetup[cellId1]);
        verify(mGridBuilderStub.mCageMockOfDefaultSetup[cageId1], times(1)).invalidateBordersOfAllCells();
        verify(mGridBuilderStub.mCageMockOfDefaultSetup[cageId2], times(0)).invalidateBordersOfAllCells();

        // Select the other cell in the same cage. The borders may not be reset
        // again. Border of both cages need to be set.
        grid.setSelectedCell(mGridBuilderStub.mCellMockOfDefaultSetup[cellId2]);
        verify(mGridBuilderStub.mCageMockOfDefaultSetup[cageId1], times(2)).invalidateBordersOfAllCells();
        verify(mGridBuilderStub.mCageMockOfDefaultSetup[cageId2], times(1)).invalidateBordersOfAllCells();
    }

    @Test
    public void
    clearRedundantPossiblesInSameRowOrColumn_AnotherCellInSameRowContainsTheRedundantPossibleValueButNoOtherPossibleValues_TheRedundantPossibleValueIsCleared() throws Exception {
        ...
        Grid grid = mGridBuilderStub.setCellMockAsSelectedCell(idSelectedCell)
                .setCellMockWithEnteredValue(idSelectedCell, rowSelectedCell, columnSelectedCell, valueSelectedCell)
                .setCellMockWithMaybeValues(idOtherCellOnSameRow, rowSelectedCell, columnSelectedCell - 1,
                                            new int[]{valueSelectedCell})
                .build();

        grid.clearRedundantPossiblesInSameRowOrColumn(mock(CellChange.class));

        verify(mGridBuilderStub.mCellMockOfDefaultSetup[idOtherCellOnSameRow]).hasPossible(valueSelectedCell);
        verify(mGridBuilderStub.mCellMockOfDefaultSetup[idOtherCellOnSameRow]).removePossible(valueSelectedCell);
    }

    @Test
    public void
    clearRedundantPossiblesInSameRowOrColumn_AnotherCellInSameRowContainsMultiplePossibleValuesIncludingTheRedundantValue_TheRedundantPossibleValueIsCleared() throws Exception {
        // Set up a grid with a for which the user value of the selected is
        // revealed and for which the same value os also used as a possible
        // value in another cell on the same row as the selected cell.
        int idSelectedCell = 14;
        ...
        verify(mGridBuilderStub.mCellMockOfDefaultSetup[idOtherCellOnSameRow]).hasPossible(valueSelectedCell);
        verify(mGridBuilderStub.mCellMockOfDefaultSetup[idOtherCellOnSameRow]).removePossible(valueSelectedCell);
        verify(mGridBuilderStub.mCellMockOfDefaultSetup[idOtherCellOnSameRow], never()).removePossible(
                valueSelectedCell - 1);
        verify(mGridBuilderStub.mCellMockOfDefaultSetup[idOtherCellOnSameRow], never()).removePossible(
                valueSelectedCell + 1);
    }
    ...
    @Test
    public void
    clearRedundantPossiblesInSameRowOrColumn_AnotherCellInSameColumnContainsTheRedundantPossibleValueButNoOtherPossibleValues_TheRedundantPossibleValueIsCleared() throws Exception {
        // Set up a grid with a for which the user value of the selected is
        ...
        Grid grid = mGridBuilderStub.setCellMockAsSelectedCell(idSelectedCell)
                .setCellMockWithEnteredValue(idSelectedCell, rowSelectedCell, columnSelectedCell, valueSelectedCell)
                .setCellMockWithMaybeValues(idOtherCellInSameColumn, rowSelectedCell - 1, columnSelectedCell,
                                            new int[]{valueSelectedCell})
                .build();

        grid.clearRedundantPossiblesInSameRowOrColumn(mock(CellChange.class));

        verify(mGridBuilderStub.mCellMockOfDefaultSetup[idOtherCellInSameColumn]).hasPossible(valueSelectedCell);
        verify(mGridBuilderStub.mCellMockOfDefaultSetup[idOtherCellInSameColumn]).removePossible(valueSelectedCell);
    }

    @Test
    public void
    clearRedundantPossiblesInSameRowOrColumn_AnotherCellInSameColumnContainsMultiplePossibleValuesIncludingTheRedundantValue_TheRedundantPossibleValueIsCleared() throws Exception {
        // Set up a grid with a for which the user value of the selected is
        // revealed and for which the same value os also used as a possible
        // value in another cell on the same row as the selected cell.
        int idSelectedCell = 14;
        ...
        verify(mGridBuilderStub.mCellMockOfDefaultSetup[idOtherCellInSameColumn]).hasPossible(valueSelectedCell);
        verify(mGridBuilderStub.mCellMockOfDefaultSetup[idOtherCellInSameColumn]).removePossible(valueSelectedCell);
        verify(mGridBuilderStub.mCellMockOfDefaultSetup[idOtherCellInSameColumn], never()).removePossible(
                valueSelectedCell - 1);
        verify(mGridBuilderStub.mCellMockOfDefaultSetup[idOtherCellInSameColumn], never()).removePossible(
                valueSelectedCell + 1);
    }
    ...
    public void gridCreateWithGridBuilder_CellsListIsNull_InvalidParameterException() throws Exception {
        mGridBuilderStub.setCells(null);
        assertThat(mGridBuilderStub.build(), is(nullValue()));
    }

    @Test(expected = InvalidGridException.class)
    public void gridCreateWithGridBuilder_CellsListIsEmpty_InvalidParameterException() throws Exception {
        mGridBuilderStub.setCells(new ArrayList<Cell>());
        assertThat(mGridBuilderStub.build(), is(nullValue()));
    }

    @Test(expected = InvalidGridException.class)
    public void gridCreateWithGridBuilder_CellsHasTooLittleCells_InvalidParameterException() throws Exception {
        mGridBuilderStub.setGridSize(2);
        mGridBuilderStub.setCellsInitializedWith(mGridBuilderStub.mAnyCellMockOfDefaultSetup,
    ...
    @Test(expected = InvalidGridException.class)
    public void gridCreateWithGridBuilder_CellsHasTooManyCells_InvalidParameterException() throws Exception {
    ...
    @Test(expected = InvalidGridException.class)
    public void gridCreateWithGridBuilder_CagesListIsNull_InvalidParameterException() throws Exception {
        mGridBuilderStub.setCages(null);
        assertThat(mGridBuilderStub.build(), is(nullValue()));
    }

    @Test(expected = InvalidGridException.class)
    public void gridCreateWithGridBuilder_CagesListIsEmpty_InvalidParameterException() throws Exception {
        mGridBuilderStub.setCages(new ArrayList<Cage>());
        assertThat(mGridBuilderStub.build(), is(nullValue()));
    }

    @Test(expected = InvalidGridException.class)
    public void gridCreateWithGridBuilder_GridGeneratingParametersIsNull_InvalidParameterException() throws Exception {
        mGridBuilderStub.setGridGeneratingParameters(null);
        assertThat(mGridBuilderStub.build(), is(nullValue()));
    }

    @Test
    public void gridCreateWithGridBuilder_ValidParameters_GridBuilderParamsUsed() throws Exception {
        mGridBuilderStub.useSameMockForAllCells()
                .useSameMockForAllCages()
                .setupDefaultWhichDoesNotThrowErrorsOnBuild();
        ...
        Grid grid = mGridBuilderStub.build();
        assertThat("Selected grid cell", grid.getSelectedCell(), is(nullValue()));
        assertThat("Solution revealed", grid.isSolutionRevealed(), is(false));
        assertThat("Solving attempt id", grid.getSolvingAttemptId(), is(equalTo(-1)));
        assertThat("Row id", grid.getRowId(), is(equalTo(-1)));
        assertThat("Grid statistics", grid.getGridStatistics(), is(sameInstance(mGridStatisticsMock)));
        assertThat("Date created filled with system time", grid.getDateCreated(), is(dateCreated));
        assertThat("Date updated filled with system time", grid.getDateSaved(), is(dateCreated));
        assertThat("Grid size", grid.getGridSize(), is(mGridBuilderStub.mGridSize));
        ...
        verify(mGridBuilderStub.mAnyCageOfDefaultSetup, times(mGridBuilderStub.mCages.size())).setGridReference(
                any(Grid.class));
        verify(mGridBuilderStub.mAnyCellMockOfDefaultSetup, times(mGridBuilderStub.mCells.size())).setGridReference(
                any(Grid.class));
        verify(mGridBuilderStub.mAnyCellMockOfDefaultSetup, times(mGridBuilderStub.mCages.size())).setCageText(
                anyString());
        verify(mGridBuilderStub.mAnyCageOfDefaultSetup,
               times(mGridBuilderStub.mCages.size())).checkMathOnEnteredValues();
        verify(mGridBuilderStub.mAnyCellMockOfDefaultSetup, never()).setDuplicateHighlight(true);
    }
    ...
    @Test
    public void containsNoEnteredValues_GridHasNoEnteredValuesAndNoMaybeValues_True() throws Exception {
        Grid grid = mGridBuilderStub.build();
    ...
    @Test
    public void containsNoEnteredValues_GridHasOneEnteredValueButNoMaybeValues_False() throws Exception {
        when(mGridBuilderStub.mAnyCellMockOfDefaultSetup.hasEnteredValue()).thenReturn(true);
        when(mGridBuilderStub.mAnyCellMockOfDefaultSetup.getEnteredValue()).thenReturn(2);
        Grid grid = mGridBuilderStub.build();
    ...
    @Test
    public void containsNoEnteredValues_GridHasOneMaybeValueButNoEnteredValues_True() throws Exception {
        when(mGridBuilderStub.mAnyCellMockOfDefaultSetup.countPossibles()).thenReturn(1);
        Grid grid = mGridBuilderStub.build();
    ...
    @Test
    public void isEmpty_GridHasNoEnteredValuesAndNoMaybeValues_True() throws Exception {
        Grid grid = mGridBuilderStub.build();
    ...
    @Test
    public void isEmpty_GridHasOneEnteredValueButNoMaybeValues_False() throws Exception {
        when(mGridBuilderStub.mAnyCellMockOfDefaultSetup.hasEnteredValue()).thenReturn(true);
        when(mGridBuilderStub.mAnyCellMockOfDefaultSetup.getEnteredValue()).thenReturn(2);
        Grid grid = mGridBuilderStub.build();
    ...
    @Test
    public void isEmpty_GridHasOneMaybeValueButNoEnteredValues_False() throws Exception {
        when(mGridBuilderStub.mAnyCellMockOfDefaultSetup.countPossibles()).thenReturn(1);
        Grid grid = mGridBuilderStub.build();
    ...
    @Test
    public void createNewGridForReplay_ContainsCellWithDuplicateValueHighlight_DuplicateHighLightIsCleared() throws
            Exception {
        ...
        // new grid.
        int idOfCell_1 = 5;
        originalGrid.getCell(idOfCell_1)
                .setDuplicateHighlight(true);

        Grid newGrid = originalGrid.createNewGridForReplay();

        assertThat(newGrid, is(notNullValue()));
        assertThat(newGrid.getCell(idOfCell_1), is(not(originalGrid.getCell(idOfCell_1))));
    }

    @Test
    public void createNewGridForReplay_ContainsCellWithEnteredValue_EnteredValueIsCleared() throws Exception {
        // Use a grid without mocks for this test.
        Grid originalGrid = GridCreator4x4.createEmptyGrid();
        // Set only one property of one cell which should not be copied to the
        // new grid.
        ...
        assertThat(newGrid.getCell(idOfCell_1)
                           .getEnteredValue(), is(not(originalGrid.getCell(idOfCell_1)
                                                              .getEnteredValue())));
    }

    @Test
    public void createNewGridForReplay_ContainsCellWithMaybeValue_PossiblesIsCleared() throws Exception {
        // Use a grid without mocks for this test.
        Grid originalGrid = GridCreator4x4.createEmptyGrid();
        // Set only one property of one cell which should not be copied to the
        // new grid.
        ...
        assertThat(newGrid, is(notNullValue()));
        assertThat(newGrid.getCell(idOfCell_1)
                           .getPossibles(), is(not(originalGrid.getCell(idOfCell_1)
                                                           .getPossibles())));
    }

    @Test
    public void createNewGridForReplay_ContainsRevealedCell_IsRevealedIsCleared() throws Exception {
        // Use a grid without mocks for this test.
        Grid originalGrid = GridCreator4x4.createEmptyGrid();
        // Set only one property of one cell which should not be copied to the
        // new grid.
        ...
        assertThat(newGrid, is(notNullValue()));
        assertThat(newGrid.getCell(idOfCell_1)
                           .isRevealed(), is(not(originalGrid.getCell(idOfCell_1)
                                                         .isRevealed())));
    }

    @Test
    public void createNewGridForReplay_InvalidUserHighlight_InvalidHighlightIsCleared() throws Exception {
        // Use a grid without mocks for this test.
        Grid originalGrid = GridCreator4x4.createEmptyGrid();
        // Set only one property of one cell which should not be copied to the
        // new grid.
    ...
    @Test
    public void createNewGridForReplay_HasSelectedCell_SelectedCellIsCleared() throws Exception {
        // Use a grid without mocks for this test.
        Grid originalGrid = GridCreator4x4.createEmptyGrid();
        // Set only one property of one cell which should not be copied to the
        // new grid.
        ...
        assertThat(newGrid, is(notNullValue()));
        assertThat(newGrid.getCell(idOfCell_1)
                           .isSelected(), is(not(originalGrid.getCell(idOfCell_1)
                                                         .isSelected())));
    }

    @Test
    public void createNewGridForReplay_RevealedCageOperator_RevealedCageOperatorIsHidden() throws Exception {
        // Use a grid without mocks for this test.
        GridCreator4x4HiddenOperators gridCreator = GridCreator4x4HiddenOperators.createEmpty();
        ...
        int idOfCell_1 = gridCreator.getIdOfUpperLeftCellOfCageWithMultipleCellsAndAnUnrevealedCageOperator();
        ...
        assertThat(newGrid, is(notNullValue()));
        assertThat(newGrid.getCell(idOfCell_1)
                           .getCageText(), is(not(originalGrid.getCell(idOfCell_1)
                                                          .getCageText())));
    }

    @Test
    public void markInvalidChoices_GridHasNoInvalidValues_GridStatisticsAreUpdated() throws Exception {
        Grid grid = mGridBuilderStub.build();

        assertThat(grid.markInvalidChoices(), is(0));

        verify(mGridStatisticsMock).increaseCounter(GridStatistics.StatisticsCounterType.ACTION_CHECK_PROGRESS);
    }

    @Test
    public void markInvalidChoices_GridHasOneCellWithInvalidValue_CellWithInvalidValueIsHighlighted() throws Exception {
        int cellId = 7;
        GridCreator testGridCreator = GridCreator4x4.createEmpty()
                .setIncorrectEnteredValueInCell(cellId);
        Grid grid = testGridCreator.getGrid();

        assertThat(grid.markInvalidChoices(), is(1));
        assertThat(grid.getCell(7)
                           .hasInvalidValueHighlight(), is(true));
    }

    @Test
    public void markInvalidChoices_GridHasTwoCellsWithInvalidValue_StatisticsOfInvalidCellsFoundUpdated() throws
            Exception {
        int cellId_1 = 7;
        int cellId_2 = 0;
        GridCreator testGridCreator = GridCreator4x4.createEmpty()
        ...
        assertThat(grid.getGridStatistics().mCheckProgressInvalidCellsFound, is(2));
    }

    @Test
    public void isReplay_GridStatisticsReplayCounterIs0_False() throws Exception {
        Grid grid = mGridBuilderStub.build();
    ...
    @Test
    public void revealSelectedCell_CellIsSelected_UndoInformationForSelectedCellIsSaved() throws Exception {
        int idSelectedCell = 14;
        Grid grid = mGridBuilderStub.setCellMockAsSelectedCell(idSelectedCell)
                .build();
    ...
    @Test
    public void revealSelectedCell_CellIsSelected_SelectedCellIsRevealed() throws Exception {
        int idSelectedCell = 14;
        Grid grid = mGridBuilderStub.setCellMockAsSelectedCell(idSelectedCell)
                .build();

        assertThat(grid.revealSelectedCell(), is(true));
        verify(mGridBuilderStub.mCellMockOfDefaultSetup[idSelectedCell]).revealCorrectValue();
    }

    @Test
    public void revealSelectedCell_CellIsSelected_SelectedCellContainsCorrectEnteredValue() throws Exception {
        int idSelectedCell = 14;
        Grid grid = mGridBuilderStub.setCellMockAsSelectedCell(idSelectedCell)
                .build();
        int correctValue = 3;
        when(mGridBuilderStub.mCellMockOfDefaultSetup[idSelectedCell].getCorrectValue()).thenReturn(correctValue);
    ...
    public void revealSelectedCell_RevealedValueIsUsedAsPossibleInOtherCellOnSameRow_RedundantPossibleValueIsRemoved
        ...
        int valueRevealed = 1;
        Grid grid = mGridBuilderStub.setCellMockAsSelectedCell(idSelectedCell)
                .setCellMockWithEnteredValue(idSelectedCell, rowSelectedCell, columnSelectedCell, valueRevealed)
                .setCellMockWithMaybeValues(idOtherCellOnSameRow, rowSelectedCell, columnSelectedCell - 1,
                                            new int[]{valueRevealed})
                .build();
        // Enable puzzle setting to clear maybes.
        when(mPreferencesMock.isPuzzleSettingClearMaybesEnabled()).thenReturn(true);
        ...
        assertThat(grid.revealSelectedCell(), is(true));
        verify(mGridBuilderStub.mCellMockOfDefaultSetup[idOtherCellOnSameRow]).removePossible(valueRevealed);
    }

    @Test
    public void revealSelectedCell_CellIsSelected_StatisticsUpdated() throws Exception {
        int idSelectedCell = 14;
        Grid grid = mGridBuilderStub.setCellMockAsSelectedCell(idSelectedCell)
                .build();
    ...
    public void revealOperatorSelectedCage_CageSelectedForCageWithHiddenOperator_OperatorRevealed() throws Exception {
        ...
        GridCreator gridCreator = GridCreator4x4HiddenOperators.createEmptyWithSelectedCell(idSelectedCell);
        int idOfUpperLeftCellOfSelectedCage = gridCreator.getIdTopLeftCellOfCageContainingCellWithId(idSelectedCell);
        Grid grid = gridCreator.getGrid();
        String cageTextBeforeReveal = grid.getCell(idOfUpperLeftCellOfSelectedCage)
                .getCageText();

        assertThat(grid.revealOperatorSelectedCage(), is(true));
        assertThat(grid.getCell(idOfUpperLeftCellOfSelectedCage)
                           .getCageText(), is(not(cageTextBeforeReveal)));
    }
    ...
    public void revealOperatorSelectedCage_CageSelectedForCageWithVisibleOperator_OperatorRevealed() throws Exception {
        ...
        Grid grid = mGridBuilderStub.setCellMockAsSelectedCell(idOfSelectedCell)
                .build();
        when(mGridBuilderStub.mAnyCageOfDefaultSetup.isOperatorHidden()).thenReturn(false);

        assertThat(grid.revealOperatorSelectedCage(), is(false));
        verify(mGridBuilderStub.mAnyCageOfDefaultSetup, never()).revealOperator();
    }
    ...
    @Test
    public void getEnteredValuesForCells_CellsIsNull_EmptyListReturned() throws Exception {
        Grid grid = mGridBuilderStub.build();

        assertThat(grid.getEnteredValuesForCells(null)
                           .size(), is(0));
    }

    @Test
    public void getEnteredValuesForCells_CellWithInvalidId_EmptyListReturned() throws Exception {
    ...
    @Test
    public void getEnteredValuesForCells_GetValueForOneCellHavingAEnteredValue_EnteredValueReturned() throws Exception {
        int idOfCell = 4;
        int valueOfCell = 3;
        when(mGridBuilderStub.mCellMockOfDefaultSetup[idOfCell].hasEnteredValue()).thenReturn(true);
        when(mGridBuilderStub.mCellMockOfDefaultSetup[idOfCell].getEnteredValue()).thenReturn(valueOfCell);
        Grid grid = mGridBuilderStub.build();

        List<Integer> expectedEnteredValues = new ArrayList<Integer>();
        expectedEnteredValues.add(valueOfCell);
        assertThat(grid.getEnteredValuesForCells(new int[]{idOfCell}), is(expectedEnteredValues));
    }
    ...
    public void getEnteredValuesForCells_GetValueForMultipleCellsAllHavingAEnteredValue_EnteredValuesReturned()
        ...
        when(mGridBuilderStub.mCellMockOfDefaultSetup[idOfCell_1].getEnteredValue()).thenReturn(valueOfCell_1);
        int idOfCell_2 = 8;
        int valueOfCell_2 = 2;
        when(mGridBuilderStub.mCellMockOfDefaultSetup[idOfCell_2].hasEnteredValue()).thenReturn(true);
        when(mGridBuilderStub.mCellMockOfDefaultSetup[idOfCell_2].getEnteredValue()).thenReturn(valueOfCell_2);
        Grid grid = mGridBuilderStub.build();
    ...
    public void getEnteredValuesForCells_GetValueForMultipleCellsNotAllHavingAEnteredValue_EnteredValuesReturned()
        ...
        when(mGridBuilderStub.mCellMockOfDefaultSetup[idOfCell_2].getEnteredValue()).thenReturn(valueOfCell_2);
        int idOfCell_3 = 9;
        when(mGridBuilderStub.mCellMockOfDefaultSetup[idOfCell_3].hasEnteredValue()).thenReturn(false);
        Grid grid = mGridBuilderStub.build();

        List<Integer> expectedEnteredValues = new ArrayList<Integer>();
        expectedEnteredValues.add(valueOfCell_1);
        expectedEnteredValues.add(valueOfCell_2);
        assertThat(grid.getEnteredValuesForCells(new int[]{idOfCell_1, idOfCell_2, idOfCell_3}),
    ...
    public void getCells_GetMultipleCells_CellsReturned() throws Exception {
        ...
        assertThat(grid.getCells(new int[]{idOfCell_1, idOfCell_2}), is(expectedCells));
    }

    @Test
    public void markDuplicateValues_EmptyGrid_NoDuplicatesFounds() throws Exception {
        Grid grid = mGridBuilderStub.build();
    ...
    @Test
    public void markDuplicateValues_GridWithEnteredValuesButNoDuplicates_NoDuplicatesFounds() throws Exception {
        Grid grid = GridCreator4x4.create()
    ...
    @Test
    public void markDuplicateValues_GridWithDuplicateEnteredValuesOnSameRow_DuplicatesFounds() throws Exception {
        Grid grid = GridCreator4x4.create()
                .setEmptyGrid()
                .getGrid();
        int row = 1;
        ...
        int col2 = col1 + 1;
        int enteredValue = 2;
        grid.getCellAt(row, col1)
                .setEnteredValue(enteredValue);
        grid.getCellAt(row, col2)
                .setEnteredValue(enteredValue);
    ...
    @Test
    public void markDuplicateValues_GridWithDuplicateEnteredValuesInSameColumn_DuplicatesFounds() throws Exception {
        Grid grid = GridCreator4x4.create()
                .setEmptyGrid()
                .getGrid();
        int row1 = 1;
        ...
        int col = 2;
        int enteredValue = 2;
        grid.getCellAt(row1, col)
                .setEnteredValue(enteredValue);
        grid.getCellAt(row2, col)
                .setEnteredValue(enteredValue);

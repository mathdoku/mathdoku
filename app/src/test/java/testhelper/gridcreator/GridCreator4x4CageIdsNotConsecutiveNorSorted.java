 ...
 * contrary to the superclass the cage ids are not consecutive nor sorted.
 * However, the resulting grid is identical to the grid in the superclass.
 */
public class GridCreator4x4CageIdsNotConsecutiveNorSorted extends
		GridCreator4x4 {
	...
	protected CageOperator[] getCageOperatorPerCage() {
		CageOperator[] cageOperatorPerCageOriginal = super
				.getCageOperatorPerCage();

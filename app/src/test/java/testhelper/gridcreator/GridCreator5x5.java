...
public class GridCreator5x5 extends GridCreator {
    ...
    public String getGridDefinition() {
        return new StringBuilder() //
                // PuzzleComplexity id
                .append("5").append(FIELD_SEPARATOR_GRID_DEFINITION_PART)
                ...
                .append(FIELD_SEPARATOR_GRID_DEFINITION_PART).append("0,240,3")
                        // Definition for cage id 1
                .append(FIELD_SEPARATOR_GRID_DEFINITION_PART).append("1,40,3")
                        // Definition for cage id 2
                .append(FIELD_SEPARATOR_GRID_DEFINITION_PART).append("2,75,3")
                        // Definition for cage id 3
                .append(FIELD_SEPARATOR_GRID_DEFINITION_PART).append("3,10,1")
                        // Definition for cage id 4
                .append(FIELD_SEPARATOR_GRID_DEFINITION_PART).append("4,72,3")
                        // Definition for cage id 5
                .append(FIELD_SEPARATOR_GRID_DEFINITION_PART).append("5,6,1")

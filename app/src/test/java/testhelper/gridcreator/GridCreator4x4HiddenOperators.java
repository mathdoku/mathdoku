...
public class GridCreator4x4HiddenOperators extends GridCreator4x4 {
    ...
    public static GridCreator4x4HiddenOperators createEmptyWithSelectedCell(int idSelectedCell) {
        GridCreator4x4HiddenOperators gridCreator = new GridCreator4x4HiddenOperators();
    ...
    public String getGridDefinition() {
        return new StringBuilder() //
                // PuzzleComplexity id
                .append("4").append(FIELD_SEPARATOR_GRID_DEFINITION_PART)
                ...
                .append(FIELD_SEPARATOR_GRID_DEFINITION_PART).append("0,48,0")
                        // Definition for cage id 1
                .append(FIELD_SEPARATOR_GRID_DEFINITION_PART).append("1,1,0")
                        // Definition for cage id 2
                .append(FIELD_SEPARATOR_GRID_DEFINITION_PART).append("2,2,0")
                        // Definition for cage id 3
                .append(FIELD_SEPARATOR_GRID_DEFINITION_PART).append("3,8,0")
                        // Definition for cage id 4
                .append(FIELD_SEPARATOR_GRID_DEFINITION_PART).append("4,12,0")

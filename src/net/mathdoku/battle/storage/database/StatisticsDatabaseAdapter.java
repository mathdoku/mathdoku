package net.mathdoku.battle.storage.database;
...
import net.mathdoku.battle.statistics.CumulativeStatistics;
import net.mathdoku.battle.statistics.GridStatistics;
import net.mathdoku.battle.statistics.HistoricStatistics;
import net.mathdoku.battle.statistics.HistoricStatistics.Serie;
import net.mathdoku.battle.storage.database.Projection.Aggregation;
...
public class StatisticsDatabaseAdapter extends DatabaseAdapter {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see net.mathdoku.battle.storage.database.DatabaseAdapter#getCreateSQL()
	 */
	@Override

package net.mathdoku.battle.storage;
...
public class GameFileConverter extends AsyncTask<Void, Void, Void> {
	...
	private static final String PATH_R110 = "/data/data/net.mathdoku.battle/";
	...
	@SuppressLint("SdCardPath")
	private static final String PATH_USAGE_LOGS = "/data/data/net.mathdoku.battle/files/";

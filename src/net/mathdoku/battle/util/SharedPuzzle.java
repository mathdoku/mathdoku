package net.mathdoku.battle.util;
...
import net.mathdoku.battle.ui.ArchiveFragment;
...
public class SharedPuzzle {
	...
	public void share(int solvingAttemptId) {
		...
		if (grid.load(solvingAttemptId)) {
			...
			String downloadUrl = "https://play.google.com/store/apps/details?id=net.mathdoku.battle";

...
public class GridCell {
  ...
  public String toString() {
    String str = "<cell:" + this.mCellNumber + " col:" + this.mColumn + " row:"
        + this.mRow + " posX:" + this.mPosX + " posY:" + this.mPosY + " val:"
        + this.mValue + ", userval: " + this.mUserValue + ">";
    return str;
  }
  ...
  public void onDraw(Canvas canvas, boolean onlyBorders) {
    ...
    if (this.isUserValueSet()) {
      ...
      canvas.drawText("" + this.mUserValue, this.mPosX + leftOffset, this.mPosY
          + topOffset, this.mValuePaint);
    }
    // Cage text
    int cageTextSize = (int) (cellSize / 3);
    this.mCageTextPaint.setTextSize(cageTextSize);
    if (!this.mCageText.equals("")) {
      canvas.drawText(this.mCageText, this.mPosX + 2,
          this.mPosY + cageTextSize, this.mCageTextPaint);
